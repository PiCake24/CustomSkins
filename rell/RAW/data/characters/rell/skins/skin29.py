...
entries: map[hash,embed] = {
    "Characters/Rell/Skins/Skin29" = SkinCharacterDataProperties {
    ...
    "Characters/Rell/Skins/Skin29/Particles/Rell_Skin29_Idle_Body_Glow1" = VfxSystemDefinitionData {
        complexEmitterDefinitionData: list[pointer] = {
            VfxEmitterDefinitionData {
                rate: embed = ValueFloat {
                    constantValue: f32 = 1
            ...
            VfxEmitterDefinitionData {
                ...
                blendMode: u8 = 1
                birthColor: embed = ValueColor {
                    constantValue: vec4 = { 0.529411793, 0.0392156877, 0.195178151, 1 }
                }
                color: embed = ValueColor {
                    dynamics: pointer = VfxAnimatedColorVariableData {
                        times: list[f32] = {
        ...
        visibilityRadius: f32 = 99999
        particleName: string = "Rell_Skin29_Idle_Body_Glow1"
        particlePath: string = "Characters/Rell/Skins/Skin29/Particles/Rell_Skin29_Idle_Body_Glow1"
    }
    "Characters/Rell/Skins/Skin29/Particles/Rell_Skin29_W_Mount_Transform_Child" = VfxSystemDefinitionData {
        complexEmitterDefinitionData: list[pointer] = {
            VfxEmitterDefinitionData {
                rate: embed = ValueFloat {
                    constantValue: f32 = 1
            ...
            VfxEmitterDefinitionData {
                ...
                texture: string = "ASSETS/Characters/Rell/Skins/Skin29/Rell_Skin29_Horse_TX_CM.tex"
            }
            VfxEmitterDefinitionData {
                rate: embed = ValueFloat {
                    constantValue: f32 = 1
        ...
        particleName: string = "Rell_Skin29_W_Mount_Transform_Child"
        particlePath: string = "Characters/Rell/Skins/Skin29/Particles/Rell_Skin29_W_Mount_Transform_Child"
    }
    "Characters/Rell/Skins/Skin29/Particles/Rell_Skin29_Idle_Body_Glow" = VfxSystemDefinitionData {
        complexEmitterDefinitionData: list[pointer] = {
            VfxEmitterDefinitionData {
                rate: embed = ValueFloat {
                    constantValue: f32 = 100
                ...
                color: embed = ValueColor {
                    dynamics: pointer = VfxAnimatedColorVariableData {
                        ...
                        values: list[vec4] = {
                            { 1, 1, 1, 0 }
                            { 1, 1, 1, 1 }
                            { 1, 0.349019617, 0.546150923, 1 }
                            { 1, 0.274509817, 0.535210192, 0 }
                        }
                    }
                }
                pass: i16 = 110
                ...
                texture: string = "ASSETS/Characters/Rell/Skins/Skin29/Particles/Rell_Skin29_Flame.tex"
                uvMode: u8 = 2
                birthUvScrollRate: embed = ValueVector2 {
                    constantValue: vec2 = { 0.25, 0.550000012 }
                    dynamics: pointer = VfxAnimatedVector2fVariableData {
            ...
            VfxEmitterDefinitionData {
                ...
                blendMode: u8 = 4
                birthColor: embed = ValueColor {
                    constantValue: vec4 = { 0.815686285, 0.00639353041, 0.411047518, 1 }
                }
                color: embed = ValueColor {
                    dynamics: pointer = VfxAnimatedColorVariableData {
                        times: list[f32] = {
                ...
                textureMult: pointer = VfxTextureMultDefinitionData {
                    textureMult: string = "ASSETS/Characters/Rell/Skins/Skin29/Particles/Rell_Skin29_Rell_Spirit_Phoenix_Flames_Mult.tex"
                    birthUvScrollRateMult: embed = ValueVector2 {
                        constantValue: vec2 = { 0.600000024, 0.5 }
                        dynamics: pointer = VfxAnimatedVector2fVariableData {
                            probabilityTables: list[pointer] = {
        ...
        visibilityRadius: f32 = 9999999
        particleName: string = "Rell_Skin29_Idle_Body_Glow"
        particlePath: string = "Characters/Rell/Skins/Skin29/Particles/Rell_Skin29_Idle_Body_Glow"
    }
    "Characters/Rell/Skins/Skin29/Materials/Specular_Fresnel_Masked_inst" = StaticMaterialDef {
        name: string = "Characters/Rell/Skins/Skin29/Materials/Specular_Fresnel_Masked_inst"
        samplerValues: list2[embed] = {
            StaticMaterialShaderSamplerDef {
                textureName: string = "Diffuse_Color"
                texturePath: string = "ASSETS/Characters/Rell/Skins/Skin29/Rell_Skin29_TX_CM.tex"
                addressU: u32 = 1
                addressV: u32 = 1
                addressW: u32 = 1
            }
        ...
        paramValues: list2[embed] = {
            StaticMaterialShaderParamDef {
                name: string = "Fresnel_Color"
                value: vec4 = { 0.909498751, 0.0905317739, 0.41756314, 1 }
            }
            StaticMaterialShaderParamDef {
                name: string = "Fresnel_Size"
                value: vec4 = { 0.5, 0, 0, 0 }
    ...
    "Characters/Rell/Skins/Skin29/Materials/Rell_Horse_VFX" = StaticMaterialDef {
        name: string = "Characters/Rell/Skins/Skin29/Materials/Rell_Horse_VFX"
        samplerValues: list2[embed] = {
            StaticMaterialShaderSamplerDef {
                textureName: string = "Diffuse_Texture"
                texturePath: string = "ASSETS/Characters/Rell/Skins/Skin29/Particles/Rell_Skin29_Darkstar_Lava.tex"
                addressU: u32 = 1
                addressV: u32 = 1
                addressW: u32 = 1
            }
        ...
        paramValues: list2[embed] = {
            ...
            StaticMaterialShaderParamDef {
                name: string = "Addative_Color"
                value: vec4 = { 0.650980413, 0.00511177257, 0.246768907, 1 }
            }
            StaticMaterialShaderParamDef {
                name: string = "Bloom_Intensity"
                value: vec4 = { 4, 0, 0, 0 }
            ...
            StaticMaterialShaderParamDef {
                name: string = "Bloom_color"
                value: vec4 = { 1, 0.0274509806, 0.411612123, 1 }
            }
        }
        switches: list2[embed] = {
            StaticMaterialSwitchDef {
    ...
    "Characters/Rell/Skins/Skin29/Materials/Rell_LanceMental" = StaticMaterialDef {
        name: string = "Characters/Rell/Skins/Skin29/Materials/Rell_LanceMental"
        samplerValues: list2[embed] = {
            StaticMaterialShaderSamplerDef {
                textureName: string = "Diffuse_Texture"
                texturePath: string = "ASSETS/Characters/Rell/Skins/Skin29/Rell_Skin29_Rell_Lance_TX_CM.tex"
                addressU: u32 = 1
                addressV: u32 = 1
                addressW: u32 = 1
            }
        ...
        paramValues: list2[embed] = {
            ...
            StaticMaterialShaderParamDef {
                name: string = "Bloom_color"
                value: vec4 = { 1, 0.0274509806, 0.397833228, 1 }
            }
        }
        switches: list2[embed] = {
            StaticMaterialSwitchDef {
    ...
    "Characters/Rell/Skins/Skin29/Resources" = ResourceResolver {
        resourceMap: map[hash,link] = {
            ...
            "Rell_E_Ally_Activate" = "Characters/Rell/Skins/Skin20/Particles/Rell_Skin20_E_Ally_Activate"
            "Rell_W_Mount_Buf_Lance" = "Characters/Rell/Skins/Skin20/Particles/Rell_Skin20_W_Mount_Buf_Lance"
            "Rell_W_Mount_Transform_Child" = "Characters/Rell/Skins/Skin29/Particles/Rell_Skin29_W_Mount_Transform_Child"
            "Rell_W_Mount_Buf_Steam" = "Characters/Rell/Skins/Skin20/Particles/Rell_Skin20_W_Mount_Buf_Steam"
            "Rell_W_Mount_Rib_Glow" = "Characters/Rell/Skins/Skin20/Particles/Rell_Skin20_W_Mount_Rib_Glow"
            "Rell_BA_Swipe_Mounted" = "Characters/Rell/Skins/Skin20/Particles/Rell_Skin20_BA_Swipe_Mounted"
            "Rell_BA_Tar" = "Characters/Rell/Skins/Skin20/Particles/Rell_Skin20_BA_Tar"
            ...
            0xd7e05705 = "Characters/Rell/Skins/Skin20/Particles/Rell_Skin20_globalhit_physical"
            "Rell_BA_Tar01" = "Characters/Rell/Skins/Skin20/Particles/Rell_Skin20_BA_Tar01"
            "Rell_Idle_Body_Glow" = "Characters/Rell/Skins/Skin29/Particles/Rell_Skin29_Idle_Body_Glow"
            "Rell_Idle_Body_Glow1" = "Characters/Rell/Skins/Skin29/Particles/Rell_Skin29_Idle_Body_Glow1"
            "Rell_R_Tumbleweed_Child" = "Characters/Rell/Skins/Skin20/Particles/Rell_Skin20_R_Tumbleweed_Child"
            0xdae9a9ef = "Characters/Rell/Skins/Skin20/Particles/Rell_Base_R_Tumbleweed_Child03"
            "Rell_R_Tumbleweed_Child03" = "Characters/Rell/Skins/Skin20/Particles/Rell_Skin20_R_Tumbleweed_Child03"
            "Rell_R_Tumbleweed_Child04" = "Characters/Rell/Skins/Skin20/Particles/Rell_Skin20_R_Tumbleweed_Child04"
