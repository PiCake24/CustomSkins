...
entries: map[hash,embed] = {
    "Characters/Chogath/Skins/Skin4" = SkinCharacterDataProperties {
        ...
        championSkinName: string = "DinosaurChogath"
        metaDataTags: string = "faction:void,gender:male,race:monster,skinline:dayjob"
        loadscreen: embed = CensoredImage {
            image: string = "ASSETS/Characters/Chogath/skins/skin04/ChogathLoadScreen_4.tex"
        }
