...
entries: map[hash,embed] = {
    "Characters/Chogath/Skins/Skin1" = SkinCharacterDataProperties {
        ...
        championSkinName: string = "NightmareChogath"
        metaDataTags: string = "faction:void,gender:male,element:dark,race:monster,skinline:legacy"
        loadscreen: embed = CensoredImage {
            image: string = "ASSETS/Characters/Chogath/skins/Skin01/ChogathLoadScreen_1.tex"
        }
