...
entries: map[hash,embed] = {
    "Characters/Chogath/Skins/Skin3" = SkinCharacterDataProperties {
        ...
        championSkinName: string = "AbyssChogath"
        metaDataTags: string = "faction:void,gender:male,race:monster,skinline:fable"
        loadscreen: embed = CensoredImage {
            image: string = "ASSETS/Characters/Chogath/skins/Skin03/ChogathLoadScreen_3.tex"
        }
