...
entries: map[hash,embed] = {
    "Characters/Chogath/Skins/Skin2" = SkinCharacterDataProperties {
        ...
        championSkinName: string = "DandyChogath"
        metaDataTags: string = "faction:void,gender:male,race:monster,skinline:gentleman"
        loadscreen: embed = CensoredImage {
            image: string = "ASSETS/Characters/Chogath/skins/Skin02/ChogathLoadScreen_2.tex"
        }
