...
entries: map[hash,embed] = {
    "Characters/Nasus/Skins/Skin42" = SkinCharacterDataProperties {
    ...
    "Characters/Nasus/Skins/Skin42/Particles/Nasus_Skin42_R_Avatar" = VfxSystemDefinitionData {
        complexEmitterDefinitionData: list[pointer] = {
            ...
            VfxEmitterDefinitionData {
                ...
                texture: string = "ASSETS/Characters/Nasus/Skins/Skin42/Nasus_Skin42_Wing_TX_CM.tex"
    ...
    "Characters/Nasus/Skins/Skin42/Particles/Nasus_Skin42_Idle_VFX_01" = VfxSystemDefinitionData {
        complexEmitterDefinitionData: list[pointer] = {
            VfxEmitterDefinitionData {
                ...
                CustomMaterial: pointer = VfxMaterialDefinitionData {
                    Material: link = "Characters/Nasus/Skins/Skin42/Materials/ScrollingUVs_Simple_inst"
                }
                ...
                blendMode: u8 = 1
                Color: embed = ValueColor {
                    constantValue: vec4 = { 0.254901975, 0.749019623, 0.517647088, 1 }
                }
                meshRenderFlags: u8 = 0
                alphaRef: u8 = 0
                depthBiasFactors: vec2 = { -1, -16 }
        ...
        particleName: string = "Nasus_Skin42_Idle_VFX_01"
        particlePath: string = "Characters/Nasus/Skins/Skin42/Particles/Nasus_Skin42_Idle_VFX_01"
    ...
    "Characters/Nasus/Skins/Skin42/Particles/Nasus_Skin42_Recall_Avatar_Enemy" = VfxSystemDefinitionData {
        complexEmitterDefinitionData: list[pointer] = {
            VfxEmitterDefinitionData {
                ...
                texture: string = "ASSETS/Characters/Nasus/Skins/Skin42/Nasus_Skin42_Recall_TX_CM.tex"
            }
        }
        visibilityRadius: f32 = 9000
        particleName: string = "Nasus_Skin42_Recall_Avatar_Enemy"
        particlePath: string = "Characters/Nasus/Skins/Skin42/Particles/Nasus_Skin42_Recall_Avatar_Enemy"
        overrideScaleCap: option[f32] = {
            350
        }
    ...
    "Characters/Nasus/Skins/Skin42/Resources" = ResourceResolver {
        resourceMap: map[hash,link] = {
            ...
            "Nasus_Q_Buf" = "Characters/Nasus/Skins/Skin42/Particles/Nasus_Skin42_Q_Buf"
            ...
            "Nasus_R_Avatar" = "Characters/Nasus/Skins/Skin42/Particles/Nasus_Skin42_R_Avatar"
    ...
    "Characters/Nasus/Skins/Skin42/Materials/ScrollingUVs_Simple_inst" = StaticMaterialDef {
        name: string = "Characters/Nasus/Skins/Skin42/Materials/ScrollingUVs_Simple_inst"
        ...
        paramValues: list2[embed] = {
            ...
            StaticMaterialShaderParamDef {
                ...
                value: vec4 = { 0.835294127, 0.192156866, 0, 0 }
            }
        }
            ...
            parameters: list[embed] = {
                DynamicMaterialParameterDef {
                    ...
                    driver: pointer = SwitchMaterialDriver {
                        ...
                        mDefaultValue: pointer = Float4LiteralMaterialDriver {
                            value: vec4 = { 1, 0.300000012, 0.219999999, 0 }
                        }
                    }
                }
            }
    ...
    "Characters/Nasus/Skins/Skin42/Materials/Wing_R_Switch_Shadow_inst" = StaticMaterialDef {
        name: string = "Characters/Nasus/Skins/Skin42/Materials/Wing_R_Switch_Shadow_inst"
        samplerValues: list2[embed] = {
            StaticMaterialShaderSamplerDef {
                TextureName: string = "Diffuse_Texture"
    ...
    "Characters/Nasus/Skins/Skin42/Materials/AnodizedMetal_inst" = StaticMaterialDef {
        name: string = "Characters/Nasus/Skins/Skin42/Materials/AnodizedMetal_inst"
        samplerValues: list2[embed] = {
            StaticMaterialShaderSamplerDef {
                TextureName: string = "Diffuse_Texture"
    ...
    "Characters/Nasus/Skins/Skin42/Materials/ScrollingUVs_MultiLayer_Alpha_Bloom_Wobble_inst" = StaticMaterialDef {
        name: string = "Characters/Nasus/Skins/Skin42/Materials/ScrollingUVs_MultiLayer_Alpha_Bloom_Wobble_inst"
        samplerValues: list2[embed] = {
            StaticMaterialShaderSamplerDef {
                TextureName: string = "Diffuse_Texture"
        ...
        paramValues: list2[embed] = {
            ...
            StaticMaterialShaderParamDef {
                ...
                value: vec4 = { 1, 0.913725495, 0.600000024, 1 }
            }
            StaticMaterialShaderParamDef {
                name: string = "Bloom_Intensity"
