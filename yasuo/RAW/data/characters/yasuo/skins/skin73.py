...
entries: map[hash,embed] = {
    "Characters/Yasuo/Skins/Skin73" = SkinCharacterDataProperties {
        skinClassification: u32 = 2
        championSkinName: string = "YasuoSkin73"
        skinParent: i32 = 68
    ...
    "Characters/Yasuo/Skins/Skin73/Resources" = ResourceResolver {
        resourceMap: map[hash,link] = {
            ...
            0x97f876a5 = "Characters/Yasuo/Skins/Skin73/Particles/Yasuo_Skin73_Idle_Arms_Glow"
        }
    }
    "Characters/Yasuo/Skins/Skin73/Particles/Yasuo_Skin73_Idle_Arms_Glow" = VfxSystemDefinitionData {
        complexEmitterDefinitionData: list[pointer] = {
            VfxEmitterDefinitionData {
                ...
                birthColor: embed = ValueColor {
                    constantValue: vec4 = { 0.110444799, 0.670588255, 0.558556497, 0.301960796 }
                }
            ...
            VfxEmitterDefinitionData {
                ...
                color: embed = ValueColor {
                    dynamics: pointer = VfxAnimatedColorVariableData {
                        ...
                        values: list[vec4] = {
                            { 0.137254909, 0.862745106, 0.694117665, 1 }
                            { 0.137254909, 0.862745106, 0.694117665, 0.309803933 }
                            { 0.137254909, 0.862745106, 0.694117665, 0.450980395 }
                            { 0.109803922, 0.478431374, 0.398809791, 0 }
                        }
                    }
                }
                pass: i16 = 200
            ...
            VfxEmitterDefinitionData {
                ...
                blendMode: u8 = 4
                birthColor: embed = ValueColor {
                    constantValue: vec4 = { 0.106553748, 0.662745118, 0.570046544, 1 }
                }
                color: embed = ValueColor {
                    dynamics: pointer = VfxAnimatedColorVariableData {
                        times: list[f32] = {
        ...
        particleName: string = "Yasuo_Skin73_Idle_Arms_Glow"
        particlePath: string = "Characters/Yasuo/Skins/Skin73/Particles/Yasuo_Skin73_Idle_Arms_Glow"
        flags: u16 = 198
    }
    "Characters/Yasuo/Skins/Skin73/Materials/Hair_Bloom_inst" = StaticMaterialDef {
        name: string = "Characters/Yasuo/Skins/Skin73/Materials/Hair_Bloom_inst"
        samplerValues: list2[embed] = {
            StaticMaterialShaderSamplerDef {
                textureName: string = "Diffuse_Texture"
                texturePath: string = "ASSETS/Characters/Yasuo/Skins/Skin73/Yasuo_Skin73_TX_CM.dds"
                addressV: u32 = 1
                addressW: u32 = 1
            }
            StaticMaterialShaderSamplerDef {
    ...
    "Characters/Yasuo/Skins/Skin73/Materials/Arms_Glow_inst" = StaticMaterialDef {
        name: string = "Characters/Yasuo/Skins/Skin73/Materials/Arms_Glow_inst"
        samplerValues: list2[embed] = {
            StaticMaterialShaderSamplerDef {
