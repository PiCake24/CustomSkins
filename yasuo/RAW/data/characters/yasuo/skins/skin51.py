...
entries: map[hash,embed] = {
    "Characters/Yasuo/Skins/Skin51" = SkinCharacterDataProperties {
        skinClassification: u32 = 2
        championSkinName: string = "YasuoSkin51"
        skinParent: i32 = 45
    ...
    "Characters/Yasuo/Skins/Skin51/Materials/ScreenSpace_Shoulder_Tentacle_inst" = StaticMaterialDef {
        name: string = "Characters/Yasuo/Skins/Skin51/Materials/ScreenSpace_Shoulder_Tentacle_inst"
        samplerValues: list2[embed] = {
            StaticMaterialShaderSamplerDef {
                textureName: string = "Diffuse_Texture"
                texturePath: string = "ASSETS/Characters/Yasuo/Skins/Skin51/Yasuo_Skin51_TX_CM.dds"
                addressU: u32 = 1
                addressV: u32 = 1
                addressW: u32 = 1
            }
            StaticMaterialShaderSamplerDef {
                ...
                texturePath: string = "ASSETS/Characters/Yasuo/Skins/Skin51/Particles/Yasuo_Skin51_HairFlow.dds"
                addressW: u32 = 1
            }
        }
        paramValues: list2[embed] = {
            ...
            StaticMaterialShaderParamDef {
                ...
                value: vec4 = { 0.890196085, 0.0392156877, 1, 1 }
            }
            StaticMaterialShaderParamDef {
    ...
    "Characters/Yasuo/Skins/Skin51/Materials/Diffuse_Bloom_Tentacles_inst" = StaticMaterialDef {
        name: string = "Characters/Yasuo/Skins/Skin51/Materials/Diffuse_Bloom_Tentacles_inst"
        samplerValues: list2[embed] = {
            StaticMaterialShaderSamplerDef {
                textureName: string = "Diffuse_Texture"
                texturePath: string = "ASSETS/Characters/Yasuo/Skins/Skin51/Yasuo_Skin51_Tentacle_TX_CM.dds"
                addressU: u32 = 1
                addressV: u32 = 1
                addressW: u32 = 1
            }
        ...
        paramValues: list2[embed] = {
            ...
            StaticMaterialShaderParamDef {
                ...
                value: vec4 = { 0.815686285, 0.0470588244, 0.741176486, 0 }
            }
            StaticMaterialShaderParamDef {
    ...
    "Characters/Yasuo/Skins/Skin51/Materials/ScreenSpace_Hair_inst" = StaticMaterialDef {
        name: string = "Characters/Yasuo/Skins/Skin51/Materials/ScreenSpace_Hair_inst"
        samplerValues: list2[embed] = {
            StaticMaterialShaderSamplerDef {
                textureName: string = "Diffuse_Texture"
                texturePath: string = "ASSETS/Characters/Yasuo/Skins/Skin51/Yasuo_Skin51_TX_CM.dds"
        ...
        paramValues: list2[embed] = {
            ...
            StaticMaterialShaderParamDef {
                name: string = "Color_Fresnel_color"
                value: vec4 = { 0.972549021, 0.650980413, 1, 1 }
            }
            StaticMaterialShaderParamDef {
                name: string = "SS_ScrollSpeed"
                value: vec4 = { 0, -0.25, 0, 0 }
            ...
            StaticMaterialShaderParamDef {
                name: string = "Bloom_Color_Fresnel_color"
                value: vec4 = { 1, 0.541176498, 0.87843138, 1 }
            }
            StaticMaterialShaderParamDef {
                name: string = "BloomIntensity"
    ...
    "Characters/Yasuo/Skins/Skin51/Resources" = ResourceResolver {
        resourceMap: map[hash,link] = {
            ...
            "Yasuo_Skin45_Idle_HairGlow" = "Characters/Yasuo/Skins/Skin51/Particles/Yasuo_Skin51_Idle_HairGlow"
            "Yasuo_Skin45_Idle_ShoulderGlow" = "Characters/Yasuo/Skins/Skin51/Particles/Yasuo_Skin51_Idle_ShoulderGlow"
    ...
    "Characters/Yasuo/Skins/Skin51/Particles/Yasuo_Skin51_Idle_ShoulderGlow" = VfxSystemDefinitionData {
        complexEmitterDefinitionData: list[pointer] = {
            VfxEmitterDefinitionData {
                ...
                color: embed = ValueColor {
                    constantValue: vec4 = { 0.498039216, 0.298039228, 0.443137258, 1 }
                    dynamics: pointer = VfxAnimatedColorVariableData {
                        ...
                        values: list[vec4] = {
                            { 0.498039216, 0.298039228, 0.182468414, 0 }
                            { 0.498039216, 0.268819749, 0.182468414, 1 }
                            { 0.498039216, 0.157785535, 0.443137258, 1 }
                            { 0.263667911, 0.232587412, 0.443137258, 0 }
                        }
                    }
                }
                alphaRef: u8 = 0
        ...
        particleName: string = "Yasuo_Skin51_Idle_ShoulderGlow"
        particlePath: string = "Characters/Yasuo/Skins/Skin51/Particles/Yasuo_Skin51_Idle_ShoulderGlow"
        flags: u16 = 197
    }
    "Characters/Yasuo/Skins/Skin51/Particles/Yasuo_Skin51_Idle_HairGlow" = VfxSystemDefinitionData {
        complexEmitterDefinitionData: list[pointer] = {
            VfxEmitterDefinitionData {
                rate: embed = ValueFloat {
                    constantValue: f32 = 4
                ...
                color: embed = ValueColor {
                    constantValue: vec4 = { 1, 0.200000003, 0.866666675, 1 }
                    dynamics: pointer = VfxAnimatedColorVariableData {
                        times: list[f32] = {
                            0
                            0.300000012
                        ...
                        values: list[vec4] = {
                            { 1, 0.200000003, 0.356863022, 0 }
                            { 1, 0.180392206, 0.356863022, 1 }
                            { 1, 0.105882391, 0.866666675, 1 }
                            { 0.529411972, 0.156078398, 0.866666675, 0 }
                        }
                    }
                }
                alphaRef: u8 = 0
            ...
            VfxEmitterDefinitionData {
                ...
                blendMode: u8 = 4
                color: embed = ValueColor {
                    constantValue: vec4 = { 1, 0.43921569, 0.925490201, 1 }
                    dynamics: pointer = VfxAnimatedColorVariableData {
                        times: list[f32] = {
                            0
                            0.200000003
                        ...
                        values: list[vec4] = {
                            { 0.850980401, 0.418546706, 0.925490201, 0 }
                            { 0.862745106, 0.415101886, 0.925490201, 1 }
                            { 0.80392158, 0.372041523, 0.925490201, 1 }
                            { 0.87843138, 0.0757862329, 0.925490201, 1 }
                        }
                    }
                }
                pass: i16 = 10
            ...
            VfxEmitterDefinitionData {
                ...
                color: embed = ValueColor {
                    constantValue: vec4 = { 1, 0.505882382, 0.937254906, 1 }
                    dynamics: pointer = VfxAnimatedColorVariableData {
                        times: list[f32] = {
                            0
                            0.300000012
                        ...
                        values: list[vec4] = {
                            { 1, 0.505882382, 0.38592878, 0 }
                            { 1, 0.456286162, 0.38592878, 1 }
                            { 1, 0.267820179, 0.937254906, 1 }
                            { 0.529411972, 0.394786537, 0.937254906, 0 }
                        }
                    }
                }
                alphaRef: u8 = 0
        ...
        particleName: string = "Yasuo_Skin51_Idle_HairGlow"
        particlePath: string = "Characters/Yasuo/Skins/Skin51/Particles/Yasuo_Skin51_Idle_HairGlow"
        flags: u16 = 197
    }
}
