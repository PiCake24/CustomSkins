...
entries: map[hash,embed] = {
    "Characters/Yasuo/Skins/Skin60" = SkinCharacterDataProperties {
        skinClassification: u32 = 2
        championSkinName: string = "YasuoSkin60"
        skinParent: i32 = 56
    ...
    "Characters/Yasuo/Skins/Skin60/Particles/Yasuo_Skin60_I_sheath_spark" = VfxSystemDefinitionData {
        ...
        particleName: string = "Yasuo_Skin60_I_sheath_spark"
        particlePath: string = "Characters/Yasuo/Skins/Skin60/Particles/Yasuo_Skin60_I_sheath_spark"
        soundPersistentDefault: string = "Play_sfx_Yasuo_YasuoSheathSpark_buffactivate"
    }
    "Characters/Yasuo/Skins/Skin60/Particles/Yasuo_Skin60_Dance_flute_wind" = VfxSystemDefinitionData {
        complexEmitterDefinitionData: list[pointer] = {
            VfxEmitterDefinitionData {
        ...
        particleName: string = "Yasuo_Skin60_Dance_flute_wind"
        particlePath: string = "Characters/Yasuo/Skins/Skin60/Particles/Yasuo_Skin60_Dance_flute_wind"
        flags: u16 = 197
    }
    "Characters/Yasuo/Skins/Skin60/Particles/Yasuo_Skin60_Idle_Shoulder_L" = VfxSystemDefinitionData {
        complexEmitterDefinitionData: list[pointer] = {
            VfxEmitterDefinitionData {
                rate: embed = ValueFloat {
                    constantValue: f32 = 1
                ...
                blendMode: u8 = 1
                birthColor: embed = ValueColor {
                    constantValue: vec4 = { 0.0313725509, 0.113725491, 0.125490203, 1 }
                }
                color: embed = ValueColor {
                    dynamics: pointer = VfxAnimatedColorVariableData {
                        times: list[f32] = {
            ...
            VfxEmitterDefinitionData {
                ...
                color: embed = ValueColor {
                    dynamics: pointer = VfxAnimatedColorVariableData {
                        ...
                        values: list[vec4] = {
                            { 0.274509817, 0.905882359, 1, 0 }
                            { 0.274509817, 0.905882359, 1, 0.568627477 }
                            { 0.0313725509, 0.113725491, 0.125490203, 1 }
                            { 0.0313725509, 0.113725491, 0.125490203, 0 }
                        }
                    }
                }
                pass: i16 = 2
            ...
            VfxEmitterDefinitionData {
                ...
                blendMode: u8 = 4
                birthColor: embed = ValueColor {
                    constantValue: vec4 = { 0.274509817, 0.905882359, 1, 1 }
                }
                color: embed = ValueColor {
                    dynamics: pointer = VfxAnimatedColorVariableData {
                        times: list[f32] = {
        ...
        particleName: string = "Yasuo_Skin60_Idle_Shoulder_L"
        particlePath: string = "Characters/Yasuo/Skins/Skin60/Particles/Yasuo_Skin60_Idle_Shoulder_L"
        flags: u16 = 197
    }
    "Characters/Yasuo/Skins/Skin60/Particles/Yasuo_Skin60_Idle_Hair01" = VfxSystemDefinitionData {
        complexEmitterDefinitionData: list[pointer] = {
            VfxEmitterDefinitionData {
                rate: embed = ValueFloat {
                    constantValue: f32 = 1
        ...
        particleName: string = "Yasuo_Skin60_Idle_Hair01"
        particlePath: string = "Characters/Yasuo/Skins/Skin60/Particles/Yasuo_Skin60_Idle_Hair01"
        flags: u16 = 197
    }
    "Characters/Yasuo/Skins/Skin60/Resources" = ResourceResolver {
        resourceMap: map[hash,link] = {
            ...
            "Yasuo_Dance_flute_wind" = "Characters/Yasuo/Skins/Skin60/Particles/Yasuo_Skin60_Dance_flute_wind"
            ...
            "Yasuo_I_sheath_spark" = "Characters/Yasuo/Skins/Skin60/Particles/Yasuo_Skin60_I_sheath_spark"
            ...
            0x4fd145b3 = "Characters/Yasuo/Skins/Skin60/Particles/Yasuo_Skin60_Idle_Shoulder_L"
            ...
            0x8e568aa7 = "Characters/Yasuo/Skins/Skin60/Particles/Yasuo_Skin60_Idle_Hair01"
