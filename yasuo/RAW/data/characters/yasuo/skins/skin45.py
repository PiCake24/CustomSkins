...
entries: map[hash,embed] = {
    "Characters/Yasuo/Skins/Skin45" = SkinCharacterDataProperties {
        skinClassification: u32 = 1
        championSkinName: string = "YasuoSkin45"
    ...
    "Characters/Yasuo/Skins/Skin45/Materials/ScreenSpace_Hair_inst" = StaticMaterialDef {
        name: string = "Characters/Yasuo/Skins/Skin45/Materials/ScreenSpace_Hair_inst"
        samplerValues: list2[embed] = {
            StaticMaterialShaderSamplerDef {
                textureName: string = "Diffuse_Texture"
                texturePath: string = "ASSETS/Characters/Yasuo/Skins/Skin45/Yasuo_Skin45_TX_CM.dds"
                addressU: u32 = 1
                addressV: u32 = 1
                addressW: u32 = 1
            }
            StaticMaterialShaderSamplerDef {
                ...
                texturePath: string = "ASSETS/Characters/Yasuo/Skins/Skin45/Particles/Yasuo_Skin45_HairFlow.dds"
                addressW: u32 = 1
            }
        }
        paramValues: list2[embed] = {
            ...
            StaticMaterialShaderParamDef {
                ...
                value: vec4 = { 0.431372553, 1, 0.858823538, 1 }
            }
            StaticMaterialShaderParamDef {
    ...
    "Characters/Yasuo/Skins/Skin45/Materials/ScreenSpace_Shoulder_Tentacle_inst" = StaticMaterialDef {
        name: string = "Characters/Yasuo/Skins/Skin45/Materials/ScreenSpace_Shoulder_Tentacle_inst"
        samplerValues: list2[embed] = {
            StaticMaterialShaderSamplerDef {
                textureName: string = "Diffuse_Texture"
                texturePath: string = "ASSETS/Characters/Yasuo/Skins/Skin45/Yasuo_Skin45_TX_CM.dds"
        ...
        paramValues: list2[embed] = {
            ...
            StaticMaterialShaderParamDef {
                name: string = "Color_Fresnel_color"
                value: vec4 = { 0.110002287, 1, 0.850003839, 0 }
            }
            StaticMaterialShaderParamDef {
                name: string = "SS_ScrollSpeed"
                value: vec4 = { 0, -0.25, 0, 0 }
    ...
    "Characters/Yasuo/Skins/Skin45/Materials/Diffuse_Bloom_Tentacles_inst" = StaticMaterialDef {
        name: string = "Characters/Yasuo/Skins/Skin45/Materials/Diffuse_Bloom_Tentacles_inst"
        samplerValues: list2[embed] = {
            StaticMaterialShaderSamplerDef {
                textureName: string = "Diffuse_Texture"
                texturePath: string = "ASSETS/Characters/Yasuo/Skins/Skin45/Yasuo_Skin45_Tentacle_TX_CM.dds"
                addressU: u32 = 1
                addressV: u32 = 1
                addressW: u32 = 1
            }
        ...
        paramValues: list2[embed] = {
            ...
            StaticMaterialShaderParamDef {
                ...
                value: vec4 = { 0.0666666701, 0.815686285, 0.31764707, 0 }
            }
            StaticMaterialShaderParamDef {
    ...
    "Characters/Yasuo/Skins/Skin45/Resources" = ResourceResolver {
        resourceMap: map[hash,link] = {
            ...
            "Yasuo_Skin45_Idle_HairGlow" = "Characters/Yasuo/Skins/Skin45/Particles/Yasuo_Skin45_Idle_HairGlow"
            "Yasuo_Skin45_Idle_ShoulderGlow" = "Characters/Yasuo/Skins/Skin45/Particles/Yasuo_Skin45_Idle_ShoulderGlow"
    ...
    "Characters/Yasuo/Skins/Skin45/Particles/Yasuo_Skin45_Idle_ShoulderGlow" = VfxSystemDefinitionData {
        complexEmitterDefinitionData: list[pointer] = {
            VfxEmitterDefinitionData {
                ...
                color: embed = ValueColor {
                    constantValue: vec4 = { 0.0666666701, 0.43921569, 0.498039216, 1 }
                    dynamics: pointer = VfxAnimatedColorVariableData {
                        ...
                        values: list[vec4] = {
                            { 0.0666666701, 0.43921569, 0.205075115, 0 }
                            { 0.0666666701, 0.396155447, 0.205075115, 1 }
                            { 0.0666666701, 0.232526049, 0.498039216, 1 }
                            { 0.0352941304, 0.342760414, 0.498039216, 0 }
                        }
                    }
                }
                alphaRef: u8 = 0
        ...
        particleName: string = "Yasuo_Skin45_Idle_ShoulderGlow"
        particlePath: string = "Characters/Yasuo/Skins/Skin45/Particles/Yasuo_Skin45_Idle_ShoulderGlow"
        flags: u16 = 197
    }
    "Characters/Yasuo/Skins/Skin45/Particles/Yasuo_Skin45_Idle_HairGlow" = VfxSystemDefinitionData {
        complexEmitterDefinitionData: list[pointer] = {
            VfxEmitterDefinitionData {
                rate: embed = ValueFloat {
                    constantValue: f32 = 4
                ...
                color: embed = ValueColor {
                    constantValue: vec4 = { 0.209994659, 0.420004576, 1, 1 }
                    dynamics: pointer = VfxAnimatedColorVariableData {
                        times: list[f32] = {
                            0
                            0.300000012
                        ...
                        values: list[vec4] = {
                            { 0.209994659, 0.420004576, 0.411765009, 0 }
                            { 0.209994659, 0.378827751, 0.411765009, 1 }
                            { 0.209994659, 0.222355455, 1, 1 }
                            { 0.111173689, 0.327768207, 1, 0 }
                        }
                    }
                }
                alphaRef: u8 = 0
        ...
        particleName: string = "Yasuo_Skin45_Idle_HairGlow"
        particlePath: string = "Characters/Yasuo/Skins/Skin45/Particles/Yasuo_Skin45_Idle_HairGlow"
        flags: u16 = 197
    }
}
