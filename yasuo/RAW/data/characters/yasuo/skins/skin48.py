...
entries: map[hash,embed] = {
    "Characters/Yasuo/Skins/Skin48" = SkinCharacterDataProperties {
        skinClassification: u32 = 2
        championSkinName: string = "YasuoSkin48"
        skinParent: i32 = 45
    ...
    "Characters/Yasuo/Skins/Skin48/Resources" = ResourceResolver {
        resourceMap: map[hash,link] = {
            ...
            "Yasuo_Skin45_Idle_HairGlow" = "Characters/Yasuo/Skins/Skin48/Particles/Yasuo_Skin48_Idle_HairGlow"
            "Yasuo_Skin45_Idle_ShoulderGlow" = "Characters/Yasuo/Skins/Skin48/Particles/Yasuo_Skin48_Idle_ShoulderGlow"
    ...
    "Characters/Yasuo/Skins/Skin48/Particles/Yasuo_Skin48_Idle_HairGlow" = VfxSystemDefinitionData {
        complexEmitterDefinitionData: list[pointer] = {
            VfxEmitterDefinitionData {
                ...
                color: embed = ValueColor {
                    constantValue: vec4 = { 0.360784322, 0.200000003, 1, 1 }
                    dynamics: pointer = VfxAnimatedColorVariableData {
                        ...
                        values: list[vec4] = {
                            { 0.360784322, 0.200000003, 0.411765009, 0 }
                            { 0.360784322, 0.180392206, 0.411765009, 1 }
                            { 0.360784322, 0.105882391, 1, 1 }
                            { 0.191003531, 0.156078398, 1, 0 }
                        }
                    }
                }
                alphaRef: u8 = 0
            ...
            VfxEmitterDefinitionData {
                ...
                color: embed = ValueColor {
                    constantValue: vec4 = { 0, 0.180392161, 1, 1 }
                    dynamics: pointer = VfxAnimatedColorVariableData {
                        times: list[f32] = {
                            0
                            0.300000012
                        ...
                        values: list[vec4] = {
                            { 0, 0.180392161, 0.411765009, 0 }
                            { 0, 0.162706688, 0.411765009, 1 }
                            { 0, 0.0955017656, 1, 1 }
                            { 0, 0.14077659, 1, 0 }
                        }
                    }
        ...
        particleName: string = "Yasuo_Skin48_Idle_HairGlow"
        particlePath: string = "Characters/Yasuo/Skins/Skin48/Particles/Yasuo_Skin48_Idle_HairGlow"
        flags: u16 = 197
    }
    "Characters/Yasuo/Skins/Skin48/Particles/Yasuo_Skin48_Idle_ShoulderGlow" = VfxSystemDefinitionData {
        complexEmitterDefinitionData: list[pointer] = {
            VfxEmitterDefinitionData {
                rate: embed = ValueFloat {
                    constantValue: f32 = 4
                ...
                color: embed = ValueColor {
                    constantValue: vec4 = { 0.0705882385, 0.184313729, 0.498039216, 1 }
                    dynamics: pointer = VfxAnimatedColorVariableData {
                        times: list[f32] = {
                            0
                            0.300000012
                        ...
                        values: list[vec4] = {
                            { 0.0705882385, 0.184313729, 0.205075115, 0 }
                            { 0.0705882385, 0.166243792, 0.205075115, 1 }
                            { 0.0705882385, 0.0975778922, 0.498039216, 1 }
                            { 0.0373702571, 0.14383696, 0.498039216, 0 }
                        }
                    }
                }
                alphaRef: u8 = 0
        ...
        particleName: string = "Yasuo_Skin48_Idle_ShoulderGlow"
        particlePath: string = "Characters/Yasuo/Skins/Skin48/Particles/Yasuo_Skin48_Idle_ShoulderGlow"
        flags: u16 = 197
    }
    "Characters/Yasuo/Skins/Skin48/Materials/ScreenSpace_Shoulder_Tentacle_inst" = StaticMaterialDef {
        name: string = "Characters/Yasuo/Skins/Skin48/Materials/ScreenSpace_Shoulder_Tentacle_inst"
        samplerValues: list2[embed] = {
            StaticMaterialShaderSamplerDef {
                textureName: string = "Diffuse_Texture"
                texturePath: string = "ASSETS/Characters/Yasuo/Skins/Skin48/Yasuo_Skin48_TX_CM.dds"
                addressU: u32 = 1
                addressV: u32 = 1
                addressW: u32 = 1
            }
            StaticMaterialShaderSamplerDef {
                ...
                texturePath: string = "ASSETS/Characters/Yasuo/Skins/Skin48/Particles/Yasuo_Skin48_HairFlow.dds"
                addressW: u32 = 1
            }
        }
        paramValues: list2[embed] = {
            ...
            StaticMaterialShaderParamDef {
                ...
                value: vec4 = { 0.0941176489, 0.333333343, 1, 0 }
            }
            StaticMaterialShaderParamDef {
    ...
    "Characters/Yasuo/Skins/Skin48/Materials/Diffuse_Bloom_Tentacles_inst" = StaticMaterialDef {
        name: string = "Characters/Yasuo/Skins/Skin48/Materials/Diffuse_Bloom_Tentacles_inst"
        samplerValues: list2[embed] = {
            StaticMaterialShaderSamplerDef {
                textureName: string = "Diffuse_Texture"
                texturePath: string = "ASSETS/Characters/Yasuo/Skins/Skin48/Yasuo_Skin48_Tentacle_TX_CM.dds"
                addressU: u32 = 1
                addressV: u32 = 1
                addressW: u32 = 1
            }
        ...
        paramValues: list2[embed] = {
            ...
            StaticMaterialShaderParamDef {
                ...
                value: vec4 = { 0.0509803928, 0.356862754, 0.815686285, 0 }
            }
            StaticMaterialShaderParamDef {
    ...
    "Characters/Yasuo/Skins/Skin48/Materials/ScreenSpace_Hair_inst" = StaticMaterialDef {
        name: string = "Characters/Yasuo/Skins/Skin48/Materials/ScreenSpace_Hair_inst"
        samplerValues: list2[embed] = {
            StaticMaterialShaderSamplerDef {
                textureName: string = "Diffuse_Texture"
                texturePath: string = "ASSETS/Characters/Yasuo/Skins/Skin48/Yasuo_Skin48_TX_CM.dds"
        ...
        paramValues: list2[embed] = {
            ...
            StaticMaterialShaderParamDef {
                name: string = "Color_Fresnel_color"
                value: vec4 = { 0.65882355, 0.431372553, 1, 1 }
            }
            StaticMaterialShaderParamDef {
                name: string = "SS_ScrollSpeed"
                value: vec4 = { 0, -0.25, 0, 0 }
            ...
            StaticMaterialShaderParamDef {
                name: string = "Bloom_Color_Fresnel_color"
                value: vec4 = { 0.423529416, 0.952941179, 1, 1 }
            }
            StaticMaterialShaderParamDef {
                name: string = "BloomIntensity"
