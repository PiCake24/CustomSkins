...
entries: map[hash,embed] = {
    "Characters/Yasuo/Skins/Skin71" = SkinCharacterDataProperties {
        skinClassification: u32 = 2
        championSkinName: string = "YasuoSkin71"
        skinParent: i32 = 68
    ...
    "Characters/Yasuo/Skins/Skin71/Materials/Arms_Glow_inst" = StaticMaterialDef {
        name: string = "Characters/Yasuo/Skins/Skin71/Materials/Arms_Glow_inst"
        samplerValues: list2[embed] = {
            ...
            StaticMaterialShaderSamplerDef {
                ...
                texturePath: string = "ASSETS/Characters/Yasuo/Skins/Skin71/Yasuo_Skin71_TX_CM.dds"
                addressU: u32 = 1
                addressV: u32 = 1
                addressW: u32 = 1
            }
    ...
    "Characters/Yasuo/Skins/Skin71/Materials/Hair_Bloom_inst" = StaticMaterialDef {
        name: string = "Characters/Yasuo/Skins/Skin71/Materials/Hair_Bloom_inst"
        samplerValues: list2[embed] = {
            StaticMaterialShaderSamplerDef {
                textureName: string = "Diffuse_Texture"
                texturePath: string = "ASSETS/Characters/Yasuo/Skins/Skin71/Yasuo_Skin71_TX_CM.dds"
    ...
    "Characters/Yasuo/Skins/Skin71/Particles/Yasuo_Skin71_Idle_Arms_Glow" = VfxSystemDefinitionData {
        complexEmitterDefinitionData: list[pointer] = {
            VfxEmitterDefinitionData {
                ...
                birthColor: embed = ValueColor {
                    constantValue: vec4 = { 0.140001521, 0.2399939, 0.859998465, 0.62999922 }
                }
            ...
            VfxEmitterDefinitionData {
                ...
                blendMode: u8 = 4
                birthColor: embed = ValueColor {
                    constantValue: vec4 = { 0.137254909, 0.303517193, 0.862745106, 1 }
                }
                color: embed = ValueColor {
                    dynamics: pointer = VfxAnimatedColorVariableData {
                        times: list[f32] = {
        ...
        particleName: string = "Yasuo_Skin71_Idle_Arms_Glow"
        particlePath: string = "Characters/Yasuo/Skins/Skin71/Particles/Yasuo_Skin71_Idle_Arms_Glow"
        flags: u16 = 198
    }
    "Characters/Yasuo/Skins/Skin71/Resources" = ResourceResolver {
        resourceMap: map[hash,link] = {
            ...
            0x97f876a5 = "Characters/Yasuo/Skins/Skin71/Particles/Yasuo_Skin71_Idle_Arms_Glow"
        }
    }
}
