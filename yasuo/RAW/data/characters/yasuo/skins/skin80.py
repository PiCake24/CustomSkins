...
entries: map[hash,embed] = {
    "Characters/Yasuo/Skins/Skin80" = SkinCharacterDataProperties {
        skinClassification: u32 = 2
        championSkinName: string = "YasuoSkin80"
        skinParent: i32 = 77
    ...
    "Characters/Yasuo/Skins/Skin80/Particles/Yasuo_Skin80_Recall_Fish02" = VfxSystemDefinitionData {
        complexEmitterDefinitionData: list[pointer] = {
            ...
            VfxEmitterDefinitionData {
                ...
                texture: string = "ASSETS/Characters/Yasuo/Skins/Skin80/Yasuo_Skin80_Recall_TX_CM.Chroma_Yasuo_AnimaSquad_2024.dds"
            }
            VfxEmitterDefinitionData {
                rate: embed = ValueFloat {
        ...
        particleName: string = "Yasuo_Skin80_Recall_Fish02"
        particlePath: string = "Characters/Yasuo/Skins/Skin80/Particles/Yasuo_Skin80_Recall_Fish02"
        flags: u16 = 197
    }
    "Characters/Yasuo/Skins/Skin80/Particles/Yasuo_Skin80_I_Sword" = VfxSystemDefinitionData {
        complexEmitterDefinitionData: list[pointer] = {
            VfxEmitterDefinitionData {
                rate: embed = ValueFloat {
                    constantValue: f32 = 1
            ...
            VfxEmitterDefinitionData {
                ...
                reflectionDefinition: pointer = VfxReflectionDefinitionData {
                    reflectionFresnelColor: vec4 = { 1, 0.439017326, 0.980834663, 1 }
                    fresnel: f32 = 0.0500000007
                    fresnelColor: vec4 = { 0.862745106, 0.0811932534, 0.784588397, 0 }
                }
                particleIsLocalOrientation: flag = true
                isUniformScale: flag = true
                birthScale0: embed = ValueVector3 {
        ...
        particleName: string = "Yasuo_Skin80_I_Sword"
        particlePath: string = "Characters/Yasuo/Skins/Skin80/Particles/Yasuo_Skin80_I_Sword"
        flags: u16 = 197
    }
    "Characters/Yasuo/Skins/Skin80/Materials/HKG_MatCap_Translucent_Jelly_inst" = StaticMaterialDef {
        name: string = "Characters/Yasuo/Skins/Skin80/Materials/HKG_MatCap_Translucent_Jelly_inst"
        samplerValues: list2[embed] = {
            StaticMaterialShaderSamplerDef {
                textureName: string = "Diffuse_Texture"
                texturePath: string = "ASSETS/Characters/Yasuo/Skins/Skin80/Yasuo_Skin80_TX_CM.Chroma_Yasuo_AnimaSquad_2024.dds"
            }
            StaticMaterialShaderSamplerDef {
    ...
    "Characters/Yasuo/Skins/Skin80/Materials/Matcap_Body" = StaticMaterialDef {
        name: string = "Characters/Yasuo/Skins/Skin80/Materials/Matcap_Body"
        samplerValues: list2[embed] = {
            StaticMaterialShaderSamplerDef {
                textureName: string = "MatCap_Tex"
    ...
    "Characters/Yasuo/Skins/Skin80/Resources" = ResourceResolver {
        resourceMap: map[hash,link] = {
            ...
            0x6deacd55 = "Characters/Yasuo/Skins/Skin80/Particles/Yasuo_Skin80_Recall_Fish02"
            ...
            0x11c02186 = "Characters/Yasuo/Skins/Skin80/Particles/Yasuo_Skin80_I_Sword"
