...
entries: map[hash,embed] = {
    "Characters/Yasuo/Skins/Skin68" = SkinCharacterDataProperties {
        skinClassification: u32 = 1
        championSkinName: string = "YasuoSkin68"
    ...
    "Characters/Yasuo/Skins/Skin68/Materials/Arms_Glow_inst" = StaticMaterialDef {
        name: string = "Characters/Yasuo/Skins/Skin68/Materials/Arms_Glow_inst"
        samplerValues: list2[embed] = {
            ...
            StaticMaterialShaderSamplerDef {
                ...
                texturePath: string = "ASSETS/Characters/Yasuo/Skins/Skin68/Yasuo_Skin68_TX_CM.dds"
                addressU: u32 = 1
                addressV: u32 = 1
                addressW: u32 = 1
            }
    ...
    "Characters/Yasuo/Skins/Skin68/Materials/Hair_Bloom_inst" = StaticMaterialDef {
        name: string = "Characters/Yasuo/Skins/Skin68/Materials/Hair_Bloom_inst"
        samplerValues: list2[embed] = {
            StaticMaterialShaderSamplerDef {
                textureName: string = "Diffuse_Texture"
                texturePath: string = "ASSETS/Characters/Yasuo/Skins/Skin68/Yasuo_Skin68_TX_CM.dds"
    ...
    "Characters/Yasuo/Skins/Skin68/Resources" = ResourceResolver {
        resourceMap: map[hash,link] = {
            ...
            0x97f876a5 = "Characters/Yasuo/Skins/Skin68/Particles/Yasuo_Skin68_Idle_Arms_Glow"
        }
    }
    "Characters/Yasuo/Skins/Skin68/Particles/Yasuo_Skin68_Idle_Arms_Glow" = VfxSystemDefinitionData {
        complexEmitterDefinitionData: list[pointer] = {
            VfxEmitterDefinitionData {
                ...
                birthColor: embed = ValueColor {
                    constantValue: vec4 = { 0.140001521, 0.60999465, 0.859998465, 0.300007641 }
                }
            ...
            VfxEmitterDefinitionData {
                ...
                color: embed = ValueColor {
                    dynamics: pointer = VfxAnimatedColorVariableData {
                        ...
                        values: list[vec4] = {
                            { 0.137254909, 0.611764729, 0.862745106, 1 }
                            { 0.137254909, 0.611764729, 0.862745106, 0.309803933 }
                            { 0.137254909, 0.611764729, 0.862745106, 0.450980395 }
                            { 0.109803922, 0.333333343, 0.478431374, 0 }
                        }
                    }
                }
                pass: i16 = 200
            ...
            VfxEmitterDefinitionData {
                ...
                blendMode: u8 = 4
                birthColor: embed = ValueColor {
                    constantValue: vec4 = { 0.137254909, 0.611764729, 0.862745106, 1 }
                }
                color: embed = ValueColor {
                    dynamics: pointer = VfxAnimatedColorVariableData {
                        times: list[f32] = {
        ...
        particleName: string = "Yasuo_Skin68_Idle_Arms_Glow"
        particlePath: string = "Characters/Yasuo/Skins/Skin68/Particles/Yasuo_Skin68_Idle_Arms_Glow"
        flags: u16 = 198
    }
}
