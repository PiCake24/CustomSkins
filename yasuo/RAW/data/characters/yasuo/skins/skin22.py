...
entries: map[hash,embed] = {
    "Characters/Yasuo/Skins/Skin22" = SkinCharacterDataProperties {
        skinClassification: u32 = 2
        championSkinName: string = "YasuoSkin22"
        skinParent: i32 = 17
    ...
    "Characters/Yasuo/Skins/Skin22/Materials/Sheath_inst" = StaticMaterialDef {
        name: string = "Characters/Yasuo/Skins/Skin22/Materials/Sheath_inst"
        samplerValues: list2[embed] = {
            StaticMaterialShaderSamplerDef {
                textureName: string = "Diffuse_Texture"
                texturePath: string = "ASSETS/Characters/Yasuo/Skins/Skin22/Yasuo_Skin22_TX_CM.dds"
                addressU: u32 = 1
                addressV: u32 = 1
                addressW: u32 = 1
            }
        ...
        paramValues: list2[embed] = {
            StaticMaterialShaderParamDef {
                ...
                value: vec4 = { 0.482352942, 0.0588235296, 1, 1 }
            }
            StaticMaterialShaderParamDef {
    ...
    "Characters/Yasuo/Skins/Skin22/Materials/Diffuse_inst" = StaticMaterialDef {
        name: string = "Characters/Yasuo/Skins/Skin22/Materials/Diffuse_inst"
        samplerValues: list2[embed] = {
            StaticMaterialShaderSamplerDef {
                textureName: string = "Diffuse_Texture"
                texturePath: string = "ASSETS/Characters/Yasuo/Skins/Skin22/Yasuo_Skin22_TX_CM.dds"
    ...
    "Characters/Yasuo/Skins/Skin22/Resources" = ResourceResolver {
