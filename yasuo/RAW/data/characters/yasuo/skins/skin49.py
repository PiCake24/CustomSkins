...
linked: list[string] = {
    ...
    "DATA/Yasuo_Skins_Skin45_Skins_Skin46_Skins_Skin47_Skins_Skin48_Skins_Skin49_Skins_Skin50_Skins_Skin51_Skins_Skin52_Skins_Skin53.bin"
...
entries: map[hash,embed] = {
    "Characters/Yasuo/Skins/Skin49" = SkinCharacterDataProperties {
        skinClassification: u32 = 2
        championSkinName: string = "YasuoSkin49"
        skinParent: i32 = 45
        metaDataTags: string = "gender:male,faction:ionia,race:human,element:wind,skinline:ruined"
        loadscreen: embed = CensoredImage {
            image: string = "ASSETS/Characters/Yasuo/Skins/Skin45/YasuoLoadscreen_45.tex"
        }
    ...
    "Characters/Yasuo/Skins/Skin49/Particles/Yasuo_Skin49_Idle_HairGlow" = VfxSystemDefinitionData {
        complexEmitterDefinitionData: list[pointer] = {
            VfxEmitterDefinitionData {
                ...
                color: embed = ValueColor {
                    constantValue: vec4 = { 0.203921571, 1, 0.337254912, 1 }
                    dynamics: pointer = VfxAnimatedColorVariableData {
                        ...
                        values: list[vec4] = {
                            { 0.203921571, 1, 0.138869762, 0 }
                            { 0.203921571, 0.901961029, 0.138869762, 1 }
                            { 0.203921571, 0.529411972, 0.337254912, 1 }
                            { 0.107958518, 0.780391991, 0.337254912, 0 }
                        }
                    }
                }
                alphaRef: u8 = 0
                ...
                texture: string = "ASSETS/Characters/Yasuo/Skins/Skin45/Particles/Yasuo_Skin45_Idle_Glow_2.dds"
            }
            VfxEmitterDefinitionData {
                rate: embed = ValueFloat {
                    constantValue: f32 = 2
                ...
                blendMode: u8 = 4
                color: embed = ValueColor {
                    constantValue: vec4 = { 0.423529416, 1, 0.294117659, 1 }
                    dynamics: pointer = VfxAnimatedColorVariableData {
                        times: list[f32] = {
                            0
                            0.200000003
                        ...
                        values: list[vec4] = {
                            { 0.36041522, 0.952941179, 0.294117659, 0 }
                            { 0.36539793, 0.945098042, 0.294117659, 1 }
                            { 0.34048444, 0.847058833, 0.294117659, 1 }
                            { 0.197647065, 1, 0.0530565158, 1 }
                        }
                    }
                }
                pass: i16 = 10
                ...
                texture: string = "ASSETS/Characters/Yasuo/Skins/Skin45/Particles/Yasuo_Skin45_Sparkle.dds"
            }
            VfxEmitterDefinitionData {
                rate: embed = ValueFloat {
                    constantValue: f32 = 4
                ...
                color: embed = ValueColor {
                    constantValue: vec4 = { 0.454901963, 1, 0.00784313772, 1 }
                    dynamics: pointer = VfxAnimatedColorVariableData {
                        times: list[f32] = {
                            0
                            0.300000012
                        ...
                        values: list[vec4] = {
                            { 0.454901963, 1, 0.0032295296, 0 }
                            { 0.454901963, 0.901961029, 0.0032295296, 1 }
                            { 0.454901963, 0.529411972, 0.00784313772, 1 }
                            { 0.240830541, 0.780391991, 0.00784313772, 0 }
                        }
                    }
                }
                alphaRef: u8 = 0
                ...
                texture: string = "ASSETS/Characters/Yasuo/Skins/Skin45/Particles/Yasuo_Skin45_Idle_Glow.dds"
            }
        }
        particleName: string = "Yasuo_Skin49_Idle_HairGlow"
        particlePath: string = "Characters/Yasuo/Skins/Skin49/Particles/Yasuo_Skin49_Idle_HairGlow"
        flags: u16 = 197
    }
    "Characters/Yasuo/Skins/Skin49/Particles/Yasuo_Skin49_Idle_ShoulderGlow" = VfxSystemDefinitionData {
        complexEmitterDefinitionData: list[pointer] = {
            VfxEmitterDefinitionData {
                rate: embed = ValueFloat {
                    constantValue: f32 = 4
                ...
                color: embed = ValueColor {
                    constantValue: vec4 = { 0.23137255, 0.498039216, 0.0627451017, 1 }
                    dynamics: pointer = VfxAnimatedColorVariableData {
                        times: list[f32] = {
                            0
                            0.300000012
                        ...
                        values: list[vec4] = {
                            { 0.23137255, 0.498039216, 0.0258362368, 0 }
                            { 0.23137255, 0.449211955, 0.0258362368, 1 }
                            { 0.23137255, 0.263667911, 0.0627451017, 1 }
                            { 0.122491397, 0.388665825, 0.0627451017, 0 }
                        }
                    }
                }
                alphaRef: u8 = 0
        ...
        particleName: string = "Yasuo_Skin49_Idle_ShoulderGlow"
        particlePath: string = "Characters/Yasuo/Skins/Skin49/Particles/Yasuo_Skin49_Idle_ShoulderGlow"
        flags: u16 = 197
    }
    "Characters/Yasuo/Skins/Skin49/Materials/ScreenSpace_Hair_inst" = StaticMaterialDef {
        name: string = "Characters/Yasuo/Skins/Skin49/Materials/ScreenSpace_Hair_inst"
        samplerValues: list2[embed] = {
            StaticMaterialShaderSamplerDef {
                textureName: string = "Diffuse_Texture"
                texturePath: string = "ASSETS/Characters/Yasuo/Skins/Skin49/Yasuo_Skin49_TX_CM.dds"
                addressU: u32 = 1
                addressV: u32 = 1
                addressW: u32 = 1
            }
            StaticMaterialShaderSamplerDef {
                ...
                texturePath: string = "ASSETS/Characters/Yasuo/Skins/Skin49/Particles/Yasuo_Skin49_HairFlow.dds"
                addressW: u32 = 1
            }
        }
        paramValues: list2[embed] = {
            ...
            StaticMaterialShaderParamDef {
                ...
                value: vec4 = { 0.827450991, 1, 0.419607848, 1 }
            }
            StaticMaterialShaderParamDef {
            ...
            StaticMaterialShaderParamDef {
                ...
                value: vec4 = { 0.435294122, 1, 0.698039234, 1 }
            }
            StaticMaterialShaderParamDef {
                name: string = "BloomIntensity"
                value: vec4 = { 2.5999999, 0, 0, 0 }
            }
            StaticMaterialShaderParamDef {
            ...
            StaticMaterialTechniqueDef {
                ...
                passes: list[embed] = {
                    StaticMaterialPassDef {
                        shader: link = "Shaders/SkinnedMesh/ScreenSpace_Masked"
    ...
    "Characters/Yasuo/Skins/Skin49/Materials/Diffuse_Bloom_Tentacles_inst" = StaticMaterialDef {
        name: string = "Characters/Yasuo/Skins/Skin49/Materials/Diffuse_Bloom_Tentacles_inst"
        samplerValues: list2[embed] = {
            StaticMaterialShaderSamplerDef {
                textureName: string = "Diffuse_Texture"
                texturePath: string = "ASSETS/Characters/Yasuo/Skins/Skin49/Yasuo_Skin49_Tentacle_TX_CM.dds"
                addressU: u32 = 1
                addressV: u32 = 1
                addressW: u32 = 1
            }
        ...
        paramValues: list2[embed] = {
            ...
            StaticMaterialShaderParamDef {
                ...
                value: vec4 = { 0.470588237, 0.815686285, 0.0705882385, 0 }
            }
            StaticMaterialShaderParamDef {
    ...
    "Characters/Yasuo/Skins/Skin49/Materials/ScreenSpace_Shoulder_Tentacle_inst" = StaticMaterialDef {
        name: string = "Characters/Yasuo/Skins/Skin49/Materials/ScreenSpace_Shoulder_Tentacle_inst"
        samplerValues: list2[embed] = {
            StaticMaterialShaderSamplerDef {
                textureName: string = "Diffuse_Texture"
                texturePath: string = "ASSETS/Characters/Yasuo/Skins/Skin49/Yasuo_Skin49_TX_CM.dds"
        ...
        paramValues: list2[embed] = {
            ...
            StaticMaterialShaderParamDef {
                name: string = "SSFresnelSize"
                value: vec4 = { 5.4000001, 0, 0, 0 }
            }
            StaticMaterialShaderParamDef {
                name: string = "Color_Fresnel_color"
                value: vec4 = { 0.580392182, 1, 0.101960786, 0 }
            }
            StaticMaterialShaderParamDef {
                name: string = "SS_ScrollSpeed"
                value: vec4 = { 0, -0.25, 0, 0 }
            ...
            StaticMaterialShaderParamDef {
                name: string = "Bloom_Color_Fresnel_color"
                value: vec4 = { 0.36470589, 1, 0.0235294122, 1 }
            }
            StaticMaterialShaderParamDef {
                name: string = "BloomIntensity"
                value: vec4 = { 1, 0, 0, 0 }
    ...
    "Characters/Yasuo/Skins/Skin49/Resources" = ResourceResolver {
        resourceMap: map[hash,link] = {
            "Yasuo_BA_Crit_hit_01" = "Characters/Yasuo/Skins/Skin45/Particles/Yasuo_Skin45_BA_Crit_hit_01"
            "Yasuo_BA_Crit_hit_02" = "Characters/Yasuo/Skins/Skin45/Particles/Yasuo_Skin45_BA_Crit_hit_02"
            "Yasuo_BA_Crit_hit_03" = "Characters/Yasuo/Skins/Skin45/Particles/Yasuo_Skin45_BA_Crit_hit_01"
            "Yasuo_BA_Crit_hit_04" = "Characters/Yasuo/Skins/Skin45/Particles/Yasuo_Skin45_BA_Crit_hit_02"
            "Yasuo_BA_hit_tar_01" = "Characters/Yasuo/Skins/Skin45/Particles/Yasuo_Skin45_BA_hit_tar_01"
            "Yasuo_BA_hit_tar_02" = "Characters/Yasuo/Skins/Skin45/Particles/Yasuo_Skin45_BA_hit_tar_02"
            "Yasuo_BA_hit_tar_03" = "Characters/Yasuo/Skins/Skin45/Particles/Yasuo_Skin45_BA_hit_tar_01"
            "Yasuo_BA_hit_tar_04" = "Characters/Yasuo/Skins/Skin45/Particles/Yasuo_Skin45_BA_hit_tar_02"
            "Yasuo_BA_trail_1" = "Characters/Yasuo/Skins/Skin45/Particles/Yasuo_Skin45_BA_trail_1"
            "Yasuo_BA_trail_2" = "Characters/Yasuo/Skins/Skin45/Particles/Yasuo_Skin45_BA_trail_2"
            "Yasuo_BA_trail_3" = "Characters/Yasuo/Skins/Skin45/Particles/Yasuo_Skin45_BA_trail_3"
            "Yasuo_BA_trail_4" = "Characters/Yasuo/Skins/Skin45/Particles/Yasuo_Skin45_BA_trail_4"
            "Yasuo_Dance_flute_wind" = "Characters/Yasuo/Skins/Skin45/Particles/Yasuo_Skin45_Dance_flute_wind"
            ...
            "Yasuo_EQ3_cas" = "Characters/Yasuo/Skins/Skin45/Particles/Yasuo_Skin45_EQ3_cas"
            "Yasuo_EQ_cas" = "Characters/Yasuo/Skins/Skin45/Particles/Yasuo_Skin45_EQ_cas"
            "Yasuo_EQ_SwordGlow" = "Characters/Yasuo/Skins/Skin0/Particles/Yasuo_Base_EQ_SwordGlow"
            "Yasuo_E_Dash" = "Characters/Yasuo/Skins/Skin45/Particles/Yasuo_Skin45_E_Dash"
            "Yasuo_E_dash_hit" = "Characters/Yasuo/Skins/Skin45/Particles/Yasuo_Skin45_E_dash_hit"
            "Yasuo_E_timer1" = "Characters/Yasuo/Skins/Skin45/Particles/Yasuo_Skin45_E_timer1"
            "Yasuo_E_timer2" = "Characters/Yasuo/Skins/Skin45/Particles/Yasuo_Skin45_E_timer2"
            "Yasuo_E_timer3" = "Characters/Yasuo/Skins/Skin45/Particles/Yasuo_Skin45_E_timer3"
            "Yasuo_E_timer4" = "Characters/Yasuo/Skins/Skin45/Particles/Yasuo_Skin45_E_timer4"
            "Yasuo_E_timer5" = "Characters/Yasuo/Skins/Skin45/Particles/Yasuo_Skin45_E_timer5"
            "Yasuo_I_sheath_spark" = "Characters/Yasuo/Skins/Skin45/Particles/Yasuo_Skin45_I_sheath_spark"
            ...
            "Yasuo_Passive_Activate" = "Characters/Yasuo/Skins/Skin45/Particles/Yasuo_Skin45_passive_activate"
            "Yasuo_Passive_Burst" = "Characters/Yasuo/Skins/Skin45/Particles/Yasuo_Skin45_Passive_Burst"
            ...
            "Yasuo_Q_hit_tar" = "Characters/Yasuo/Skins/Skin45/Particles/Yasuo_Skin45_Q_hit_tar"
            "Yasuo_Q_sound" = "Characters/Yasuo/Skins/Skin0/Particles/Yasuo_Base_Q_sound"
            "Yasuo_Q_WindStrike" = "Characters/Yasuo/Skins/Skin45/Particles/Yasuo_Skin45_Q_WindStrike"
            "Yasuo_Q_WindStrike_02" = "Characters/Yasuo/Skins/Skin45/Particles/Yasuo_Skin45_Q_WindStrike_02"
            "Yasuo_Q_wind_hit_tar" = "Characters/Yasuo/Skins/Skin45/Particles/Yasuo_Skin45_Q_wind_hit_tar"
            "Yasuo_Q_wind_mis" = "Characters/Yasuo/Skins/Skin45/Particles/Yasuo_Skin45_Q_wind_mis"
            "Yasuo_Q_wind_ready_buff" = "Characters/Yasuo/Skins/Skin45/Particles/Yasuo_Skin45_Q_wind_ready_buff"
            ...
            "Yasuo_R_dash" = "Characters/Yasuo/Skins/Skin45/Particles/Yasuo_Skin45_R_dash"
            "Yasuo_R_impact_tar" = "Characters/Yasuo/Skins/Skin45/Particles/Yasuo_Skin45_R_impact_tar"
            "Yasuo_R_indicator_beam" = "Characters/Yasuo/Skins/Skin0/Particles/Yasuo_base_R_indicator_beam"
            "Yasuo_R_land_tar" = "Characters/Yasuo/Skins/Skin45/Particles/Yasuo_Skin45_R_land_tar"
            "Yasuo_R_slash_cas" = "Characters/Yasuo/Skins/Skin45/Particles/Yasuo_Skin45_R_slash_cas"
            "Yasuo_R_SwordGlow" = "Characters/Yasuo/Skins/Skin45/Particles/Yasuo_Skin45_R_SwordGlow"
            ...
            "Yasuo_W_windwall1" = "Characters/Yasuo/Skins/Skin45/Particles/Yasuo_Skin45_W_windwall1"
            "Yasuo_W_windwall2" = "Characters/Yasuo/Skins/Skin45/Particles/Yasuo_Skin45_W_windwall2"
            "Yasuo_W_windwall3" = "Characters/Yasuo/Skins/Skin45/Particles/Yasuo_Skin45_W_windwall3"
            "Yasuo_W_windwall4" = "Characters/Yasuo/Skins/Skin45/Particles/Yasuo_Skin45_W_windwall4"
            "Yasuo_W_windwall5" = "Characters/Yasuo/Skins/Skin45/Particles/Yasuo_Skin45_W_windwall5"
            "Yasuo_W_windwall_activate" = "Characters/Yasuo/Skins/Skin0/Particles/Yasuo_Base_W_windwall_activate"
            "Yasuo_W_Windwall_big_impact" = "Characters/Yasuo/Skins/Skin45/Particles/Yasuo_Skin45_W_windwall_big_impact"
            "Yasuo_W_windwall_enemy_01" = "Characters/Yasuo/Skins/Skin45/Particles/Yasuo_Skin45_w_windwall_enemy_01"
            "Yasuo_W_windwall_enemy_02" = "Characters/Yasuo/Skins/Skin45/Particles/Yasuo_Skin45_w_windwall_enemy_02"
            "Yasuo_W_windwall_enemy_03" = "Characters/Yasuo/Skins/Skin45/Particles/Yasuo_Skin45_w_windwall_enemy_03"
            "Yasuo_W_windwall_enemy_04" = "Characters/Yasuo/Skins/Skin45/Particles/Yasuo_Skin45_w_windwall_enemy_04"
            "Yasuo_W_windwall_enemy_05" = "Characters/Yasuo/Skins/Skin45/Particles/Yasuo_Skin45_w_windwall_enemy_05"
            ...
            "Yasuo_Skin45_Idle_HairGlow" = "Characters/Yasuo/Skins/Skin49/Particles/Yasuo_Skin49_Idle_HairGlow"
            "Yasuo_Skin45_Idle_ShoulderGlow" = "Characters/Yasuo/Skins/Skin49/Particles/Yasuo_Skin49_Idle_ShoulderGlow"
            0xe62565b9 = "Characters/Yasuo/Skins/Skin45/Particles/Yasuo_Skin45_Recall_Recall_Whirlpool"
            0x6d52ac86 = "Characters/Yasuo/Skins/Skin45/Particles/Yasuo_Skin45_Recall_FootSplash"
            0x7111e905 = "Characters/Yasuo/Skins/Skin45/Particles/Yasuo_Skin45_Recall_SwordShine"
        }
    }
}
