...
entries: map[hash,embed] = {
    "Characters/Yasuo/Skins/Skin52" = SkinCharacterDataProperties {
        skinClassification: u32 = 2
        championSkinName: string = "YasuoSkin52"
        skinParent: i32 = 45
    ...
    "Characters/Yasuo/Skins/Skin52/Materials/ScreenSpace_Shoulder_Tentacle_inst" = StaticMaterialDef {
        name: string = "Characters/Yasuo/Skins/Skin52/Materials/ScreenSpace_Shoulder_Tentacle_inst"
        samplerValues: list2[embed] = {
            StaticMaterialShaderSamplerDef {
                textureName: string = "Diffuse_Texture"
                texturePath: string = "ASSETS/Characters/Yasuo/Skins/Skin52/Yasuo_Skin52_TX_CM.dds"
                addressU: u32 = 1
                addressV: u32 = 1
                addressW: u32 = 1
            }
            StaticMaterialShaderSamplerDef {
                ...
                texturePath: string = "ASSETS/Characters/Yasuo/Skins/Skin52/Particles/Yasuo_Skin52_HairFlow.dds"
                addressW: u32 = 1
            }
        }
        paramValues: list2[embed] = {
            ...
            StaticMaterialShaderParamDef {
                ...
                value: vec4 = { 1, 0.117647059, 0.380392164, 0 }
            }
            StaticMaterialShaderParamDef {
            ...
            StaticMaterialShaderParamDef {
                ...
                value: vec4 = { 1, 0.0235294122, 0.545098066, 1 }
            }
            StaticMaterialShaderParamDef {
    ...
    "Characters/Yasuo/Skins/Skin52/Materials/Diffuse_Bloom_Tentacles_inst" = StaticMaterialDef {
        name: string = "Characters/Yasuo/Skins/Skin52/Materials/Diffuse_Bloom_Tentacles_inst"
        samplerValues: list2[embed] = {
            StaticMaterialShaderSamplerDef {
                textureName: string = "Diffuse_Texture"
                texturePath: string = "ASSETS/Characters/Yasuo/Skins/Skin52/Yasuo_Skin52_Tentacle_TX_CM.dds"
                addressU: u32 = 1
                addressV: u32 = 1
                addressW: u32 = 1
            }
        ...
        paramValues: list2[embed] = {
            ...
            StaticMaterialShaderParamDef {
                ...
                value: vec4 = { 0.815686285, 0.0627451017, 0.301960796, 0 }
            }
            StaticMaterialShaderParamDef {
    ...
    "Characters/Yasuo/Skins/Skin52/Materials/ScreenSpace_Hair_inst" = StaticMaterialDef {
        name: string = "Characters/Yasuo/Skins/Skin52/Materials/ScreenSpace_Hair_inst"
        samplerValues: list2[embed] = {
            StaticMaterialShaderSamplerDef {
                textureName: string = "Diffuse_Texture"
                texturePath: string = "ASSETS/Characters/Yasuo/Skins/Skin52/Yasuo_Skin52_TX_CM.dds"
        ...
        paramValues: list2[embed] = {
            ...
            StaticMaterialShaderParamDef {
                name: string = "Color_Fresnel_color"
                value: vec4 = { 1, 0.423529416, 0.894117653, 1 }
            }
            StaticMaterialShaderParamDef {
                name: string = "SS_ScrollSpeed"
                value: vec4 = { 0, -0.25, 0, 0 }
            ...
            StaticMaterialShaderParamDef {
                name: string = "Bloom_Color_Fresnel_color"
                value: vec4 = { 1, 0.447058827, 0.576470613, 1 }
            }
            StaticMaterialShaderParamDef {
                name: string = "BloomIntensity"
    ...
    "Characters/Yasuo/Skins/Skin52/Particles/Yasuo_Skin52_Idle_ShoulderGlow" = VfxSystemDefinitionData {
        complexEmitterDefinitionData: list[pointer] = {
            VfxEmitterDefinitionData {
                ...
                color: embed = ValueColor {
                    constantValue: vec4 = { 0.498039216, 0.0745098069, 0.137254909, 1 }
                    dynamics: pointer = VfxAnimatedColorVariableData {
                        ...
                        values: list[vec4] = {
                            { 0.498039216, 0.0745098069, 0.0565167665, 0 }
                            { 0.498039216, 0.0672049373, 0.0565167665, 1 }
                            { 0.498039216, 0.0394463837, 0.137254909, 1 }
                            { 0.263667911, 0.058146853, 0.137254909, 0 }
                        }
                    }
                }
                alphaRef: u8 = 0
        ...
        particleName: string = "Yasuo_Skin52_Idle_ShoulderGlow"
        particlePath: string = "Characters/Yasuo/Skins/Skin52/Particles/Yasuo_Skin52_Idle_ShoulderGlow"
        flags: u16 = 197
    }
    "Characters/Yasuo/Skins/Skin52/Particles/Yasuo_Skin52_Idle_HairGlow" = VfxSystemDefinitionData {
        complexEmitterDefinitionData: list[pointer] = {
            VfxEmitterDefinitionData {
                rate: embed = ValueFloat {
                    constantValue: f32 = 4
                ...
                color: embed = ValueColor {
                    constantValue: vec4 = { 1, 0.219607845, 0.360784322, 1 }
                    dynamics: pointer = VfxAnimatedColorVariableData {
                        times: list[f32] = {
                            0
                            0.300000012
                        ...
                        values: list[vec4] = {
                            { 1, 0.219607845, 0.148558363, 0 }
                            { 1, 0.198077723, 0.148558363, 1 }
                            { 1, 0.116263025, 0.360784322, 1 }
                            { 0.529411972, 0.171380207, 0.360784322, 0 }
                        }
                    }
                }
                alphaRef: u8 = 0
            ...
            VfxEmitterDefinitionData {
                ...
                blendMode: u8 = 4
                color: embed = ValueColor {
                    constantValue: vec4 = { 1, 0.286274523, 0.450980395, 1 }
                    dynamics: pointer = VfxAnimatedColorVariableData {
                        times: list[f32] = {
                            0
                            0.200000003
                        ...
                        values: list[vec4] = {
                            { 0.850980401, 0.27280277, 0.450980395, 0 }
                            { 0.862745106, 0.270557493, 0.450980395, 1 }
                            { 0.80392158, 0.24249135, 0.450980395, 1 }
                            { 1, 0.055009611, 0.12202999, 1 }
                        }
                    }
                }
                pass: i16 = 10
            ...
            VfxEmitterDefinitionData {
                ...
                color: embed = ValueColor {
                    constantValue: vec4 = { 1, 0.0274509806, 0.235294119, 1 }
                    dynamics: pointer = VfxAnimatedColorVariableData {
                        times: list[f32] = {
                            0
                            0.300000012
                        ...
                        values: list[vec4] = {
                            { 1, 0.0274509806, 0.0968858823, 0 }
                            { 1, 0.0247597154, 0.0968858823, 1 }
                            { 1, 0.0145328781, 0.235294119, 1 }
                            { 0.529411972, 0.0214225259, 0.235294119, 0 }
                        }
                    }
                }
                alphaRef: u8 = 0
        ...
        particleName: string = "Yasuo_Skin52_Idle_HairGlow"
        particlePath: string = "Characters/Yasuo/Skins/Skin52/Particles/Yasuo_Skin52_Idle_HairGlow"
        flags: u16 = 197
    }
    "Characters/Yasuo/Skins/Skin52/Resources" = ResourceResolver {
        resourceMap: map[hash,link] = {
            ...
            "Yasuo_Skin45_Idle_HairGlow" = "Characters/Yasuo/Skins/Skin52/Particles/Yasuo_Skin52_Idle_HairGlow"
            "Yasuo_Skin45_Idle_ShoulderGlow" = "Characters/Yasuo/Skins/Skin52/Particles/Yasuo_Skin52_Idle_ShoulderGlow"
