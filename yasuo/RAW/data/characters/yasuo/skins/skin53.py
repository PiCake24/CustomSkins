...
entries: map[hash,embed] = {
    "Characters/Yasuo/Skins/Skin53" = SkinCharacterDataProperties {
        skinClassification: u32 = 2
        championSkinName: string = "YasuoSkin53"
        skinParent: i32 = 45
    ...
    "Characters/Yasuo/Skins/Skin53/Resources" = ResourceResolver {
        resourceMap: map[hash,link] = {
            ...
            "Yasuo_Skin45_Idle_HairGlow" = "Characters/Yasuo/Skins/Skin53/Particles/Yasuo_Skin53_Idle_HairGlow"
            "Yasuo_Skin45_Idle_ShoulderGlow" = "Characters/Yasuo/Skins/Skin53/Particles/Yasuo_Skin53_Idle_ShoulderGlow"
    ...
    "Characters/Yasuo/Skins/Skin53/Particles/Yasuo_Skin53_Idle_HairGlow" = VfxSystemDefinitionData {
        complexEmitterDefinitionData: list[pointer] = {
            VfxEmitterDefinitionData {
                ...
                color: embed = ValueColor {
                    constantValue: vec4 = { 0.737254918, 1, 0.992156863, 1 }
                    dynamics: pointer = VfxAnimatedColorVariableData {
                        ...
                        values: list[vec4] = {
                            { 0.737254918, 1, 0.40853548, 0 }
                            { 0.737254918, 0.901961029, 0.40853548, 1 }
                            { 0.737254918, 0.529411972, 0.992156863, 1 }
                            { 0.390311569, 0.780391991, 0.992156863, 0 }
                        }
                    }
                }
                alphaRef: u8 = 0
            ...
            VfxEmitterDefinitionData {
                ...
                color: embed = ValueColor {
                    constantValue: vec4 = { 0.717647076, 0.964705884, 1, 1 }
                    dynamics: pointer = VfxAnimatedColorVariableData {
                        times: list[f32] = {
                            0
                            0.300000012
                        ...
                        values: list[vec4] = {
                            { 0.717647076, 0.964705884, 0.411765009, 0 }
                            { 0.717647076, 0.870127082, 0.411765009, 1 }
                            { 0.717647076, 0.510726869, 1, 1 }
                            { 0.379930943, 0.752848744, 1, 0 }
                        }
                    }
                }
                alphaRef: u8 = 0
        ...
        particleName: string = "Yasuo_Skin53_Idle_HairGlow"
        particlePath: string = "Characters/Yasuo/Skins/Skin53/Particles/Yasuo_Skin53_Idle_HairGlow"
        flags: u16 = 197
    }
    "Characters/Yasuo/Skins/Skin53/Particles/Yasuo_Skin53_Idle_ShoulderGlow" = VfxSystemDefinitionData {
        complexEmitterDefinitionData: list[pointer] = {
            VfxEmitterDefinitionData {
                rate: embed = ValueFloat {
                    constantValue: f32 = 4
                ...
                color: embed = ValueColor {
                    constantValue: vec4 = { 0.376470596, 0.498039216, 0.482352942, 1 }
                    dynamics: pointer = VfxAnimatedColorVariableData {
                        times: list[f32] = {
                            0
                            0.300000012
                        ...
                        values: list[vec4] = {
                            { 0.376470596, 0.498039216, 0.198616058, 0 }
                            { 0.376470596, 0.449211955, 0.198616058, 1 }
                            { 0.376470596, 0.263667911, 0.482352942, 1 }
                            { 0.199308038, 0.388665825, 0.482352942, 0 }
                        }
                    }
                }
                alphaRef: u8 = 0
        ...
        particleName: string = "Yasuo_Skin53_Idle_ShoulderGlow"
        particlePath: string = "Characters/Yasuo/Skins/Skin53/Particles/Yasuo_Skin53_Idle_ShoulderGlow"
        flags: u16 = 197
    }
    "Characters/Yasuo/Skins/Skin53/Materials/ScreenSpace_Hair_inst" = StaticMaterialDef {
        name: string = "Characters/Yasuo/Skins/Skin53/Materials/ScreenSpace_Hair_inst"
        samplerValues: list2[embed] = {
            StaticMaterialShaderSamplerDef {
                textureName: string = "Diffuse_Texture"
                texturePath: string = "ASSETS/Characters/Yasuo/Skins/Skin53/Yasuo_Skin53_TX_CM.dds"
                addressU: u32 = 1
                addressV: u32 = 1
                addressW: u32 = 1
            }
            StaticMaterialShaderSamplerDef {
                ...
                texturePath: string = "ASSETS/Characters/Yasuo/Skins/Skin53/Particles/Yasuo_Skin53_HairFlow.dds"
                addressW: u32 = 1
            }
        }
        paramValues: list2[embed] = {
            ...
            StaticMaterialShaderParamDef {
                ...
                value: vec4 = { 0.701960802, 0.796078444, 1, 1 }
            }
            StaticMaterialShaderParamDef {
            ...
            StaticMaterialShaderParamDef {
                ...
                value: vec4 = { 0.752941191, 0.831372559, 1, 1 }
            }
            StaticMaterialShaderParamDef {
    ...
    "Characters/Yasuo/Skins/Skin53/Materials/Diffuse_Bloom_Tentacles_inst" = StaticMaterialDef {
        name: string = "Characters/Yasuo/Skins/Skin53/Materials/Diffuse_Bloom_Tentacles_inst"
        samplerValues: list2[embed] = {
            StaticMaterialShaderSamplerDef {
                textureName: string = "Diffuse_Texture"
                texturePath: string = "ASSETS/Characters/Yasuo/Skins/Skin53/Yasuo_Skin53_Tentacle_TX_CM.dds"
                addressU: u32 = 1
                addressV: u32 = 1
                addressW: u32 = 1
            }
        ...
        paramValues: list2[embed] = {
            ...
            StaticMaterialShaderParamDef {
                ...
                value: vec4 = { 0.592156887, 0.788235307, 0.815686285, 0 }
            }
            StaticMaterialShaderParamDef {
    ...
    "Characters/Yasuo/Skins/Skin53/Materials/ScreenSpace_Shoulder_Tentacle_inst" = StaticMaterialDef {
        name: string = "Characters/Yasuo/Skins/Skin53/Materials/ScreenSpace_Shoulder_Tentacle_inst"
        samplerValues: list2[embed] = {
            StaticMaterialShaderSamplerDef {
                textureName: string = "Diffuse_Texture"
                texturePath: string = "ASSETS/Characters/Yasuo/Skins/Skin53/Yasuo_Skin53_TX_CM.dds"
        ...
        paramValues: list2[embed] = {
            ...
            StaticMaterialShaderParamDef {
                name: string = "Color_Fresnel_color"
                value: vec4 = { 0.643137276, 0.835294127, 1, 0 }
            }
            StaticMaterialShaderParamDef {
                name: string = "SS_ScrollSpeed"
                value: vec4 = { 0, -0.25, 0, 0 }
            ...
            StaticMaterialShaderParamDef {
                name: string = "Bloom_Color_Fresnel_color"
                value: vec4 = { 0.0235294122, 1, 0.937254906, 1 }
            }
            StaticMaterialShaderParamDef {
                name: string = "BloomIntensity"
                value: vec4 = { 1, 0, 0, 0 }
