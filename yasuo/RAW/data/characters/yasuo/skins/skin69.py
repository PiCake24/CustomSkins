...
entries: map[hash,embed] = {
    "Characters/Yasuo/Skins/Skin69" = SkinCharacterDataProperties {
        skinClassification: u32 = 2
        championSkinName: string = "YasuoSkin69"
        skinParent: i32 = 68
    ...
    "Characters/Yasuo/Skins/Skin69/Materials/Hair_Bloom_inst" = StaticMaterialDef {
        name: string = "Characters/Yasuo/Skins/Skin69/Materials/Hair_Bloom_inst"
        samplerValues: list2[embed] = {
            StaticMaterialShaderSamplerDef {
                textureName: string = "Diffuse_Texture"
                texturePath: string = "ASSETS/Characters/Yasuo/Skins/Skin69/Yasuo_Skin69_TX_CM.dds"
                addressV: u32 = 1
                addressW: u32 = 1
            }
            StaticMaterialShaderSamplerDef {
    ...
    "Characters/Yasuo/Skins/Skin69/Materials/Arms_Glow_inst" = StaticMaterialDef {
        name: string = "Characters/Yasuo/Skins/Skin69/Materials/Arms_Glow_inst"
        samplerValues: list2[embed] = {
            StaticMaterialShaderSamplerDef {
    ...
    "Characters/Yasuo/Skins/Skin69/Resources" = ResourceResolver {
        resourceMap: map[hash,link] = {
            ...
            0x97f876a5 = "Characters/Yasuo/Skins/Skin69/Particles/Yasuo_Skin69_Idle_Arms_Glow"
        }
    }
    "Characters/Yasuo/Skins/Skin69/Particles/Yasuo_Skin69_Idle_Arms_Glow" = VfxSystemDefinitionData {
        complexEmitterDefinitionData: list[pointer] = {
            VfxEmitterDefinitionData {
                ...
                birthColor: embed = ValueColor {
                    constantValue: vec4 = { 0.968627453, 0.3801938, 0.167132065, 0.301960796 }
                }
            ...
            VfxEmitterDefinitionData {
                ...
                color: embed = ValueColor {
                    dynamics: pointer = VfxAnimatedColorVariableData {
                        ...
                        values: list[vec4] = {
                            { 0.968627453, 0.474509805, 0.325490206, 1 }
                            { 0.970000744, 0.469993144, 0.330006868, 0.310002297 }
                            { 0.970000744, 0.469993144, 0.330006868, 0.450003803 }
                            { 0.478431374, 0.183535516, 0.109803922, 0 }
                        }
                    }
                }
                pass: i16 = 200
            ...
            VfxEmitterDefinitionData {
                ...
                blendMode: u8 = 4
                birthColor: embed = ValueColor {
                    constantValue: vec4 = { 0.917647064, 0.403921574, 0.266666681, 1 }
                }
                color: embed = ValueColor {
                    dynamics: pointer = VfxAnimatedColorVariableData {
                        times: list[f32] = {
        ...
        particleName: string = "Yasuo_Skin69_Idle_Arms_Glow"
        particlePath: string = "Characters/Yasuo/Skins/Skin69/Particles/Yasuo_Skin69_Idle_Arms_Glow"
        flags: u16 = 198
    }
}
