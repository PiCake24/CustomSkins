...
entries: map[hash,embed] = {
    "Characters/Yasuo/Skins/Skin47" = SkinCharacterDataProperties {
        skinClassification: u32 = 2
        championSkinName: string = "YasuoSkin47"
        skinParent: i32 = 45
    ...
    "Characters/Yasuo/Skins/Skin47/Particles/Yasuo_Skin47_Idle_ShoulderGlow" = VfxSystemDefinitionData {
        complexEmitterDefinitionData: list[pointer] = {
            VfxEmitterDefinitionData {
                ...
                color: embed = ValueColor {
                    constantValue: vec4 = { 0.498039216, 0.400000006, 0.0549019612, 1 }
                    dynamics: pointer = VfxAnimatedColorVariableData {
                        ...
                        values: list[vec4] = {
                            { 0.498039216, 0.400000006, 0.0226067062, 0 }
                            { 0.498039216, 0.360784411, 0.0226067062, 1 }
                            { 0.498039216, 0.211764783, 0.0549019612, 1 }
                            { 0.263667911, 0.312156796, 0.0549019612, 0 }
                        }
                    }
                }
                alphaRef: u8 = 0
        ...
        particleName: string = "Yasuo_Skin47_Idle_ShoulderGlow"
        particlePath: string = "Characters/Yasuo/Skins/Skin47/Particles/Yasuo_Skin47_Idle_ShoulderGlow"
        flags: u16 = 197
    }
    "Characters/Yasuo/Skins/Skin47/Particles/Yasuo_Skin47_Idle_HairGlow" = VfxSystemDefinitionData {
        complexEmitterDefinitionData: list[pointer] = {
            VfxEmitterDefinitionData {
                rate: embed = ValueFloat {
                    constantValue: f32 = 4
                ...
                color: embed = ValueColor {
                    constantValue: vec4 = { 1, 0.623529434, 0.188235298, 1 }
                    dynamics: pointer = VfxAnimatedColorVariableData {
                        times: list[f32] = {
                            0
                            0.300000012
                        ...
                        values: list[vec4] = {
                            { 1, 0.623529434, 0.0775087103, 0 }
                            { 1, 0.562399209, 0.0775087103, 1 }
                            { 1, 0.330103934, 0.188235298, 1 }
                            { 0.529411972, 0.486597359, 0.188235298, 0 }
                        }
                    }
                }
                alphaRef: u8 = 0
            ...
            VfxEmitterDefinitionData {
                ...
                blendMode: u8 = 4
                color: embed = ValueColor {
                    constantValue: vec4 = { 1, 0.792156875, 0.164705887, 1 }
                    dynamics: pointer = VfxAnimatedColorVariableData {
                        times: list[f32] = {
                            0
                            0.200000003
                        ...
                        values: list[vec4] = {
                            { 0.850980401, 0.754878879, 0.164705887, 0 }
                            { 0.862745106, 0.748665929, 0.164705887, 1 }
                            { 0.80392158, 0.671003461, 0.164705887, 1 }
                            { 1, 0.428696662, 0.0277739335, 1 }
                        }
                    }
                }
                pass: i16 = 10
            ...
            VfxEmitterDefinitionData {
                ...
                color: embed = ValueColor {
                    constantValue: vec4 = { 1, 0.850980401, 0.00784313772, 1 }
                    dynamics: pointer = VfxAnimatedColorVariableData {
                        times: list[f32] = {
                            0
                            0.300000012
                        ...
                        values: list[vec4] = {
                            { 1, 0.850980401, 0.0032295296, 0 }
                            { 1, 0.767551124, 0.0032295296, 1 }
                            { 1, 0.450519204, 0.00784313772, 1 }
                            { 0.529411972, 0.664098263, 0.00784313772, 0 }
                        }
                    }
                }
                alphaRef: u8 = 0
        ...
        particleName: string = "Yasuo_Skin47_Idle_HairGlow"
        particlePath: string = "Characters/Yasuo/Skins/Skin47/Particles/Yasuo_Skin47_Idle_HairGlow"
        flags: u16 = 197
    }
    "Characters/Yasuo/Skins/Skin47/Resources" = ResourceResolver {
        resourceMap: map[hash,link] = {
            ...
            "Yasuo_Skin45_Idle_HairGlow" = "Characters/Yasuo/Skins/Skin47/Particles/Yasuo_Skin47_Idle_HairGlow"
            "Yasuo_Skin45_Idle_ShoulderGlow" = "Characters/Yasuo/Skins/Skin47/Particles/Yasuo_Skin47_Idle_ShoulderGlow"
    ...
    "Characters/Yasuo/Skins/Skin47/Materials/Diffuse_Bloom_Tentacles_inst" = StaticMaterialDef {
        name: string = "Characters/Yasuo/Skins/Skin47/Materials/Diffuse_Bloom_Tentacles_inst"
        samplerValues: list2[embed] = {
            StaticMaterialShaderSamplerDef {
                textureName: string = "Diffuse_Texture"
                texturePath: string = "ASSETS/Characters/Yasuo/Skins/Skin47/Yasuo_Skin47_Tentacle_TX_CM.dds"
                addressU: u32 = 1
                addressV: u32 = 1
                addressW: u32 = 1
            }
        ...
        paramValues: list2[embed] = {
            ...
            StaticMaterialShaderParamDef {
                ...
                value: vec4 = { 0.815686285, 0.41568628, 0.0627451017, 0 }
            }
            StaticMaterialShaderParamDef {
    ...
    "Characters/Yasuo/Skins/Skin47/Materials/ScreenSpace_Hair_inst" = StaticMaterialDef {
        name: string = "Characters/Yasuo/Skins/Skin47/Materials/ScreenSpace_Hair_inst"
        samplerValues: list2[embed] = {
            StaticMaterialShaderSamplerDef {
                textureName: string = "Diffuse_Texture"
                texturePath: string = "ASSETS/Characters/Yasuo/Skins/Skin47/Yasuo_Skin47_TX_CM.dds"
                addressU: u32 = 1
                addressV: u32 = 1
                addressW: u32 = 1
            }
            StaticMaterialShaderSamplerDef {
                ...
                texturePath: string = "ASSETS/Characters/Yasuo/Skins/Skin47/Particles/Yasuo_Skin47_HairFlow.dds"
                addressW: u32 = 1
            }
        }
        paramValues: list2[embed] = {
            ...
            StaticMaterialShaderParamDef {
                ...
                value: vec4 = { 1, 0.580392182, 0.411764711, 1 }
            }
            StaticMaterialShaderParamDef {
            ...
            StaticMaterialShaderParamDef {
                ...
                value: vec4 = { 1, 0.686274529, 0.431372553, 1 }
            }
            StaticMaterialShaderParamDef {
    ...
    "Characters/Yasuo/Skins/Skin47/Materials/ScreenSpace_Shoulder_Tentacle_inst" = StaticMaterialDef {
        name: string = "Characters/Yasuo/Skins/Skin47/Materials/ScreenSpace_Shoulder_Tentacle_inst"
        samplerValues: list2[embed] = {
            StaticMaterialShaderSamplerDef {
                textureName: string = "Diffuse_Texture"
                texturePath: string = "ASSETS/Characters/Yasuo/Skins/Skin47/Yasuo_Skin47_TX_CM.dds"
        ...
        paramValues: list2[embed] = {
            ...
            StaticMaterialShaderParamDef {
                name: string = "Color_Fresnel_color"
                value: vec4 = { 1, 0.78039217, 0.117647059, 0 }
            }
            StaticMaterialShaderParamDef {
                name: string = "SS_ScrollSpeed"
                value: vec4 = { 0, -0.25, 0, 0 }
            ...
            StaticMaterialShaderParamDef {
                name: string = "Bloom_Color_Fresnel_color"
                value: vec4 = { 1, 0.75686276, 0.0196078438, 1 }
            }
            StaticMaterialShaderParamDef {
                name: string = "BloomIntensity"
                value: vec4 = { 1, 0, 0, 0 }
