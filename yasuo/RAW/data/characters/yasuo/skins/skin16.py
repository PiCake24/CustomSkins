...
linked: list[string] = {
    ...
    "DATA/Yasuo_Skins_Skin10_Skins_Skin11_Skins_Skin12_Skins_Skin13_Skins_Skin14_Skins_Skin15_Skins_Skin16.bin"
}
entries: map[hash,embed] = {
    "Characters/Yasuo/Skins/Skin16" = SkinCharacterDataProperties {
        skinClassification: u32 = 2
        championSkinName: string = "YasuoSkin16"
        skinParent: i32 = 10
        metaDataTags: string = "gender:male,faction:ionia,race:human,skinline:odyssey"
        loadscreen: embed = CensoredImage {
            image: string = "ASSETS/Characters/Yasuo/Skins/Skin10/YasuoLoadscreen_10.tex"
        }
        loadscreenVintage: embed = CensoredImage {
            image: string = "ASSETS/Characters/Yasuo/Skins/Skin10/YasuoLoadScreen_10_LE.tex"
        }
