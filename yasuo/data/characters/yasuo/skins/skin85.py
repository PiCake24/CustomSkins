...
entries: map[hash,embed] = {
    0xb750522b = SkinCharacterDataProperties {
    ...
    0x05a015e3 = VfxSystemDefinitionData {
    ...
    0xa3611778 = VfxSystemDefinitionData {
        complexEmitterDefinitionData: list[pointer] = {
            VfxEmitterDefinitionData {
                rate: embed = ValueFloat {
                    constantValue: f32 = 1
