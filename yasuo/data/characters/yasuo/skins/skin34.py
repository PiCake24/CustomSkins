...
linked: list[string] = {
    ...
    "DATA/Yasuo_Skins_Skin34_Skins_Skin87_Skins_Skin9.bin"
    "DATA/Yasuo_Skins_Skin34_Skins_Skin9.bin"
}
entries: map[hash,embed] = {
    "Characters/Yasuo/Skins/Skin34" = SkinCharacterDataProperties {
        skinClassification: u32 = 2
        championSkinName: string = "YasuoSkin34"
        skinParent: i32 = 9
        metaDataTags: string = "gender:male,faction:ionia,race:human,element:wind,skinline:nightbringer"
        loadscreen: embed = CensoredImage {
            image: string = "ASSETS/Characters/Yasuo/Skins/Skin09/YasuoLoadscreen_9.tex"
        }
        loadscreenVintage: embed = CensoredImage {
            image: string = "ASSETS/Characters/Yasuo/Skins/Skin09/YasuoLoadscreen_9_LE.tex"
        }
    ...
    "Characters/Yasuo/Skins/Skin34/Particles/Yasuo_Skin34_Z_Recall_BodyGlow" = VfxSystemDefinitionData {
        complexEmitterDefinitionData: list[pointer] = {
            VfxEmitterDefinitionData {
                ...
                color: embed = ValueColor {
                    constantValue: vec4 = { 0.776471019, 0.176470995, 0.0313730016, 0.400000006 }
                    dynamics: pointer = VfxAnimatedColorVariableData {
                        ...
                        values: list[vec4] = {
                            { 0.776471019, 0.176470995, 0.0313730016, 0.400000006 }
                            { 0.776471019, 0.176470995, 0.0313730016, 0.400000006 }
                            { 0.776471019, 0.176470995, 0.0313730016, 0.400000006 }
                            { 0, 0, 0, 0 }
                        }
                ...
                texture: string = "ASSETS/Characters/Yasuo/Skins/Skin09/Particles/Yasuo_Skin09_ColorHold.dds"
            }
            VfxEmitterDefinitionData {
                rate: embed = ValueFloat {
                ...
                primitive: pointer = VfxPrimitiveMesh {
                    mMesh: embed = VfxMeshDefinitionData {
                        mSimpleMeshName: string = "ASSETS/Characters/Yasuo/Skins/Skin09/Particles/Yasuo_Skin09_Q_RingSmoke_01.scb"
                    }
                }
                blendMode: u8 = 4
                color: embed = ValueColor {
                    constantValue: vec4 = { 1, 1, 1, 0.807995975 }
                    dynamics: pointer = VfxAnimatedColorVariableData {
                        times: list[f32] = {
                            0
                            0.349999994
                ...
                alphaErosionDefinition: pointer = VfxAlphaErosionDefinitionData {
                    ...
                    erosionMapName: string = "ASSETS/Characters/Yasuo/Skins/Skin09/Particles/Yasuo_Skin09_Z_Ribbon_03.dds"
                ...
                birthScale0: embed = ValueVector3 {
                    constantValue: vec3 = { 1.62, 1.62, 1.62 }
                    dynamics: pointer = VfxAnimatedVector3fVariableData {
                        probabilityTables: list[pointer] = {
                            VfxProbabilityTableData {
                                keyTimes: list[f32] = {
                ...
                texture: string = "ASSETS/Characters/Yasuo/Skins/Skin09/Particles/Yasuo_Skin09_Z_Ribbon_05.dds"
                uvMode: u8 = 2
                ...
                textureMult: pointer = 0xb097c1bd {
                    textureMult: string = "ASSETS/Characters/Yasuo/Skins/Skin09/Particles/Yasuo_Skin09_Q_RingMult_01.dds"
            ...
            VfxEmitterDefinitionData {
                ...
                birthColor: embed = ValueColor {
                    constantValue: vec4 = { 1, 1, 0.498039246, 0.301960796 }
                }
                color: embed = ValueColor {
                    dynamics: pointer = VfxAnimatedColorVariableData {
                        times: list[f32] = {
                ...
                birthScale0: embed = ValueVector3 {
                    constantValue: vec3 = { 304, 240, 240 }
                    dynamics: pointer = VfxAnimatedVector3fVariableData {
                        probabilityTables: list[pointer] = {
                            VfxProbabilityTableData {
                                keyTimes: list[f32] = {
                ...
                texture: string = "ASSETS/Characters/Yasuo/Skins/Skin09/Particles/Yasuo_Skin09_Z_Glow_02.dds"
            }
            VfxEmitterDefinitionData {
                ...
                color: embed = ValueColor {
                    dynamics: pointer = VfxAnimatedColorVariableData {
                        ...
                        values: list[vec4] = {
                            { 1, 0.333332986, 0, 0 }
                            { 0.0274509992, 0.0274509992, 0.474510014, 1 }
                            { 0, 0, 0, 1 }
                        }
                    }
                }
                ...
                alphaErosionDefinition: pointer = VfxAlphaErosionDefinitionData {
                    ...
                    erosionMapName: string = "ASSETS/Characters/Yasuo/Skins/Skin09/Particles/Yasuo_Skin09_Z_SmokeClouds_02.dds"
                    erosionMapAddressMode: u8 = 0
                }
                isUniformScale: flag = true
                ...
                birthScale0: embed = ValueVector3 {
                    constantValue: vec3 = { 18, 6, 0.300000012 }
                    dynamics: pointer = VfxAnimatedVector3fVariableData {
                        probabilityTables: list[pointer] = {
                            VfxProbabilityTableData {
                                keyTimes: list[f32] = {
                ...
                texture: string = "ASSETS/Characters/Yasuo/Skins/Skin09/Particles/Yasuo_Skin09_Z_Flecks_01.dds"
                numFrames: u16 = 4
                texDiv: vec2 = { 2, 2 }
            }
            VfxEmitterDefinitionData {
                ...
                texture: string = "ASSETS/Characters/Yasuo/Skins/Skin34/Yasuo_Skin34_Demon_CM_TX.dds"
                materialOverrideDefinitions: list[embed] = {
                    VfxMaterialOverrideDefinitionData {
                        baseTexture: string = "ASSETS/Characters/Yasuo/Skins/Skin34/Yasuo_Skin34_Demon_CM_TX.dds"
                    }
                }
            }
        }
        particleName: string = "Yasuo_Skin34_Z_Recall_BodyGlow"
        particlePath: string = "Characters/Yasuo/Skins/Skin34/Particles/Yasuo_Skin34_Z_Recall_BodyGlow"
        flags: u16 = 197
    }
    "Characters/Yasuo/Skins/Skin34/Particles/Yasuo_Skin34_Z_Death_Impact" = VfxSystemDefinitionData {
        complexEmitterDefinitionData: list[pointer] = {
            VfxEmitterDefinitionData {
                rate: embed = ValueFloat {
                    constantValue: f32 = 1
                ...
                isSingleParticle: flag = true
                emitterName: string = "StaticMesh_2"
                bindWeight: embed = ValueFloat {
                    constantValue: f32 = 1
                }
                primitive: pointer = VfxPrimitiveAttachedMesh {
                ...
                blendMode: u8 = 1
                birthColor: embed = ValueColor {
                    constantValue: vec4 = { 0.203921586, 0.203921586, 0.203921586, 0.631372571 }
                }
                color: embed = ValueColor {
                    dynamics: pointer = VfxAnimatedColorVariableData {
                        times: list[f32] = {
                ...
                alphaErosionDefinition: pointer = VfxAlphaErosionDefinitionData {
                    ...
                    erosionMapName: string = "ASSETS/Characters/Yasuo/Skins/Skin09/Particles/Yasuo_Skin09_Q_AvatarErode_01invert.dds"
                ...
                texture: string = "ASSETS/Characters/Yasuo/Skins/Skin09/Particles/Yasuo_Skin09_ColorHold_Black.dds"
            }
            VfxEmitterDefinitionData {
                rate: embed = ValueFloat {
                    constantValue: f32 = 1
                ...
                blendMode: u8 = 4
                color: embed = ValueColor {
                    constantValue: vec4 = { 0.776471019, 0.180391997, 0.0313730016, 0.618996978 }
                    dynamics: pointer = VfxAnimatedColorVariableData {
                        times: list[f32] = {
                            0
                            0.100000001
                        ...
                        values: list[vec4] = {
                            { 0.776471019, 0.180391997, 0.0313730016, 0.618996978 }
                            { 0.776471019, 0.180391997, 0.0313730016, 0.618996978 }
                            { 0.776471019, 0.180391997, 0.0313730016, 0.618996978 }
                            { 0, 0, 0, 0 }
                        }
                ...
                texture: string = "ASSETS/Characters/Yasuo/Skins/Skin09/Particles/Yasuo_Skin09_Z_AlphaFresnel.dds"
            }
            VfxEmitterDefinitionData {
                rate: embed = ValueFloat {
                    constantValue: f32 = 1
                ...
                blendMode: u8 = 3
                particleIsLocalOrientation: flag = true
                texture: string = "ASSETS/Characters/Yasuo/Skins/Skin34/Yasuo_Skin34_Death_CM_TX.dds"
                materialOverrideDefinitions: list[embed] = {
                    VfxMaterialOverrideDefinitionData {
                        baseTexture: string = "ASSETS/Characters/Yasuo/Skins/Skin34/Yasuo_Skin34_Death_CM_TX.dds"
                    }
                }
            }
            VfxEmitterDefinitionData {
        ...
        particleName: string = "Yasuo_Skin34_Z_Death_Impact"
        particlePath: string = "Characters/Yasuo/Skins/Skin34/Particles/Yasuo_Skin34_Z_Death_Impact"
        flags: u16 = 199
    }
    "Characters/Yasuo/Skins/Skin34/Particles/Yasuo_Skin34_R_SwordGlow" = VfxSystemDefinitionData {
        complexEmitterDefinitionData: list[pointer] = {
            VfxEmitterDefinitionData {
                particleLifetime: embed = ValueFloat {
                    constantValue: f32 = 2
                ...
                particleColorTexture: string = "ASSETS/Characters/Yasuo/Skins/Base/Particles/common_trans-renektonblade.dds"
                blendMode: u8 = 4
            ...
            VfxEmitterDefinitionData {
                ...
                texture: string = "ASSETS/Characters/Yasuo/Skins/Skin09/Particles/Yasuo_Skin09_Z_Flames_02.dds"
                numFrames: u16 = 8
                texDiv: vec2 = { 4, 2 }
            }
            VfxEmitterDefinitionData {
                ...
                emitterName: string = "FlamesCore1"
                birthVelocity: embed = ValueVector3 {
                    constantValue: vec3 = { -100, 50, 50 }
                    dynamics: pointer = VfxAnimatedVector3fVariableData {
                        probabilityTables: list[pointer] = {
                ...
                texture: string = "ASSETS/Characters/Yasuo/Skins/Skin09/Particles/Yasuo_Skin09_Z_Flames_01.dds"
                numFrames: u16 = 8
                texDiv: vec2 = { 4, 2 }
            }
            VfxEmitterDefinitionData {
                timeBeforeFirstEmission: f32 = 15
                rate: embed = ValueFloat {
                    constantValue: f32 = 1
                }
                particleLifetime: embed = ValueFloat {
                ...
                alphaErosionDefinition: pointer = VfxAlphaErosionDefinitionData {
                    ...
                    erosionSliceWidth: f32 = 1
                    erosionMapName: string = "ASSETS/Characters/Yasuo/Skins/Skin09/Particles/Yasuo_Skin09_Q_AvatarErode_01.dds"
                    erosionMapChannelMixer: embed = ValueColor {
                ...
                texture: string = "ASSETS/Characters/Yasuo/Skins/Skin09/Particles/Yasuo_Skin09_Z_Noise_01.dds"
                numFrames: u16 = 4
                birthUvScrollRate: embed = ValueVector2 {
        ...
        particleName: string = "Yasuo_Skin34_R_SwordGlow"
        particlePath: string = "Characters/Yasuo/Skins/Skin34/Particles/Yasuo_Skin34_R_SwordGlow"
    }
    "Characters/Yasuo/Skins/Skin34/Particles/Yasuo_Skin34_R_Ghosts_01" = VfxSystemDefinitionData {
        complexEmitterDefinitionData: list[pointer] = {
            VfxEmitterDefinitionData {
                ...
                emitterName: string = "SlashLightUp"
                birthVelocity: embed = ValueVector3 {
                ...
                texture: string = "ASSETS/Characters/Yasuo/Skins/Skin09/Particles/Yasuo_Skin09_Q_Slash_01.dds"
            ...
            VfxEmitterDefinitionData {
                ...
                primitive: pointer = VfxPrimitiveMesh {
                    mMesh: embed = VfxMeshDefinitionData {
                        mSimpleMeshName: string = "ASSETS/Characters/Yasuo/Skins/Skin09/Particles/Yasuo_Skin09_R_Slashes_01.scb"
                    }
                }
                blendMode: u8 = 1
                birthColor: embed = ValueColor {
                    constantValue: vec4 = { 0.168627456, 0.168627456, 0.168627456, 1 }
                }
                color: embed = ValueColor {
                    dynamics: pointer = VfxAnimatedColorVariableData {
                        times: list[f32] = {
                ...
                texture: string = "ASSETS/Characters/Yasuo/Skins/Skin09/Particles/Yasuo_Skin09_R_Slashes_01.dds"
                birthUvScrollRate: embed = ValueVector2 {
            ...
            VfxEmitterDefinitionData {
                ...
                childParticleSetDefinition: pointer = VfxChildParticleSetDefinitionData {
                    childrenIdentifiers: list[embed] = {
                        VfxChildIdentifier {
                            effectKey: hash = "Yasuo_R_Ghost_Trail"
                        }
                    }
                }
                emitterName: string = "StaticMesh_1"
                birthVelocity: embed = ValueVector3 {
                    constantValue: vec3 = { -5000, 0, 0 }
                }
                birthDrag: embed = ValueVector3 {
                ...
                primitive: pointer = VfxPrimitiveMesh {
                    mMesh: embed = VfxMeshDefinitionData {
                        mSimpleMeshName: string = "ASSETS/Characters/Yasuo/Skins/Skin09/Particles/Yasuo_Skin09_R_ShadowPose_01.scb"
                    }
                }
                blendMode: u8 = 1
                birthColor: embed = ValueColor {
                    constantValue: vec4 = { 0.203921586, 0.203921586, 0.203921586, 0.549019635 }
                }
                pass: i16 = 2
                alphaErosionDefinition: pointer = VfxAlphaErosionDefinitionData {
                    erosionDriveCurve: embed = ValueFloat {
            ...
            VfxEmitterDefinitionData {
                ...
                emitterName: string = "StaticMesh_3"
                birthVelocity: embed = ValueVector3 {
                    constantValue: vec3 = { -5000, 0, 0 }
                    dynamics: pointer = VfxAnimatedVector3fVariableData {
                        probabilityTables: list[pointer] = {
            ...
            VfxEmitterDefinitionData {
                ...
                emitterName: string = "StaticMesh_5"
                birthVelocity: embed = ValueVector3 {
                    constantValue: vec3 = { -5000, 0, 0 }
                    dynamics: pointer = VfxAnimatedVector3fVariableData {
                        probabilityTables: list[pointer] = {
        ...
        particleName: string = "Yasuo_Skin34_R_Ghosts_01"
        particlePath: string = "Characters/Yasuo/Skins/Skin34/Particles/Yasuo_Skin34_R_Ghosts_01"
    }
    "Characters/Yasuo/Skins/Skin34/Particles/Yasuo_Skin34_Q_wind_ready_buff" = VfxSystemDefinitionData {
        complexEmitterDefinitionData: list[pointer] = {
            VfxEmitterDefinitionData {
                particleLinger: option[f32] = {
                    13
                ...
                materialOverrideDefinitions: list[embed] = {
                    VfxMaterialOverrideDefinitionData {
                        baseTexture: string = "ASSETS/Characters/Yasuo/Skins/Skin34/Yasuo_Skin34_Q_CM_TX.dds"
                    }
                }
            }
            VfxEmitterDefinitionData {
            ...
            VfxEmitterDefinitionData {
                ...
                emitterName: string = "GroundWaves"
                importance: u8 = 2
                birthOrbitalVelocity: embed = ValueVector3 {
                    constantValue: vec3 = { 0, -1, 0 }
                    dynamics: pointer = VfxAnimatedVector3fVariableData {
                ...
                color: embed = ValueColor {
                    dynamics: pointer = VfxAnimatedColorVariableData {
                        ...
                        values: list[vec4] = {
                            { 1, 1, 0, 0 }
                            { 0.639216006, 0.211765006, 0.0156859998, 1 }
                            { 0.172548994, 0, 0, 0 }
                        }
                    }
                }
                alphaErosionDefinition: pointer = VfxAlphaErosionDefinitionData {
                    ...
                    erosionFeatherOut: f32 = 0.5
                    erosionSliceWidth: f32 = 1
                    erosionMapName: string = "ASSETS/Characters/Yasuo/Skins/Skin09/Particles/Yasuo_Skin09_Z_Flares_03.dds"
                    erosionMapChannelMixer: embed = ValueColor {
                        constantValue: vec4 = { 1, 0, 0, 0 }
                    }
                    erosionMapAddressMode: u8 = 0
                ...
                texture: string = "ASSETS/Characters/Yasuo/Skins/Skin09/Particles/Yasuo_Skin09_Z_Flares_03twirl.dds"
            }
            VfxEmitterDefinitionData {
                rate: embed = ValueFloat {
                    constantValue: f32 = 8
                ...
                color: embed = ValueColor {
                    dynamics: pointer = VfxAnimatedColorVariableData {
                        ...
                        values: list[vec4] = {
                            { 0.403921992, 0.141176, 0.00784299988, 0 }
                            { 0.290196002, 0.00392200006, 0.00784299988, 1 }
                            { 0, 0, 0, 1 }
                        }
                    }
                }
                ...
                scale0: embed = ValueVector3 {
                    dynamics: pointer = VfxAnimatedVector3fVariableData {
                        ...
                        values: list[vec3] = {
                            ...
                            { 0.800000012, 3.5, 0.800000012 }
                            { 1, 8, 1 }
                        }
                    }
                }
                texture: string = "ASSETS/Characters/Yasuo/Skins/Skin09/Particles/Yasuo_Skin09_Z_Ribbon_03.dds"
                uvMode: u8 = 2
                birthUvScrollRate: embed = ValueVector2 {
                    constantValue: vec2 = { 1.5, 0 }
                }
            ...
            VfxEmitterDefinitionData {
                ...
                texture: string = "ASSETS/Characters/Yasuo/Skins/Skin09/Particles/Yasuo_Skin09_Z_Flares_01.dds"
                numFrames: u16 = 4
                texDiv: vec2 = { 2, 2 }
            }
            VfxEmitterDefinitionData {
                ...
                blendMode: u8 = 1
                birthColor: embed = ValueColor {
                    constantValue: vec4 = { 1, 1, 1, 0.53725493 }
                }
                color: embed = ValueColor {
                    dynamics: pointer = VfxAnimatedColorVariableData {
                        times: list[f32] = {
                ...
                texture: string = "ASSETS/Characters/Yasuo/Skins/Skin09/Particles/Yasuo_Skin09_Z_Sparks_02.dds"
                numFrames: u16 = 4
                texDiv: vec2 = { 2, 2 }
            }
            VfxEmitterDefinitionData {
                ...
                blendMode: u8 = 1
                color: embed = ValueColor {
                    constantValue: vec4 = { 0.113724999, 0.113724999, 0.113724999, 1 }
                    dynamics: pointer = VfxAnimatedColorVariableData {
                        times: list[f32] = {
                            0
                            0.200000003
                        ...
                        values: list[vec4] = {
                            { 0.113724999, 0.113724999, 0, 0 }
                            { 0.113724999, 0.0758167058, 0, 1 }
                            { 0.113724999, 0, 0, 0 }
                        }
                    }
                }
                ...
                texture: string = "ASSETS/Characters/Yasuo/Skins/Skin09/Particles/Yasuo_Skin09_Z_Glow_01.dds"
            }
            VfxEmitterDefinitionData {
                rate: embed = ValueFloat {
                    constantValue: f32 = 30
                ...
                primitive: pointer = VfxPrimitiveMesh {
                    mMesh: embed = VfxMeshDefinitionData {
                        mSimpleMeshName: string = "ASSETS/Characters/Yasuo/Skins/Skin09/Particles/Yasuo_Skin09_Q_Tornado01.scb"
                    }
                }
                blendMode: u8 = 4
                birthColor: embed = ValueColor {
                ...
                texture: string = "ASSETS/Characters/Yasuo/Skins/Skin09/Particles/Yasuo_Skin09_Q_Tornado_01.dds"
                textureMult: pointer = 0xb097c1bd {
                    textureMult: string = "ASSETS/Characters/Yasuo/Skins/Skin09/Particles/Yasuo_Skin09_Z_Ribbon_05.dds"
                }
            }
        }
        particleName: string = "Yasuo_Skin34_Q_wind_ready_buff"
        particlePath: string = "Characters/Yasuo/Skins/Skin34/Particles/Yasuo_Skin34_Q_wind_ready_buff"
        soundPersistentDefault: string = "Play_sfx_YasuoSkin09_YasuoQW_buffactivate"
    }
    "Characters/Yasuo/Skins/Skin34/Resources" = ResourceResolver {
        resourceMap: map[hash,link] = {
            "Yasuo_BA_Crit_hit_01" = "Characters/Yasuo/Skins/Skin9/Particles/Yasuo_Skin09_BA_Crit_hit_01"
            "Yasuo_BA_Crit_hit_02" = "Characters/Yasuo/Skins/Skin9/Particles/Yasuo_Skin09_BA_Crit_hit_02"
            "Yasuo_BA_Crit_hit_03" = "Characters/Yasuo/Skins/Skin9/Particles/Yasuo_Skin09_BA_Crit_hit_03"
            "Yasuo_BA_Crit_hit_04" = "Characters/Yasuo/Skins/Skin9/Particles/Yasuo_Skin09_BA_Crit_hit_04"
            "Yasuo_BA_hit_tar_01" = "Characters/Yasuo/Skins/Skin9/Particles/Yasuo_Skin09_BA_hit_tar_01"
            "Yasuo_BA_hit_tar_02" = "Characters/Yasuo/Skins/Skin9/Particles/Yasuo_Skin09_BA_hit_tar_02"
            "Yasuo_BA_hit_tar_03" = "Characters/Yasuo/Skins/Skin9/Particles/Yasuo_Skin09_BA_hit_tar_03"
            "Yasuo_BA_hit_tar_04" = "Characters/Yasuo/Skins/Skin9/Particles/Yasuo_Skin09_BA_hit_tar_04"
            "Yasuo_BA_trail_1" = "Characters/Yasuo/Skins/Skin9/Particles/Yasuo_Skin09_BA_trail_1"
            "Yasuo_BA_trail_2" = "Characters/Yasuo/Skins/Skin9/Particles/Yasuo_Skin09_BA_trail_2"
            "Yasuo_BA_trail_3" = "Characters/Yasuo/Skins/Skin9/Particles/Yasuo_Skin09_BA_trail_3"
            "Yasuo_BA_trail_4" = "Characters/Yasuo/Skins/Skin9/Particles/Yasuo_Skin09_BA_trail_4"
            ...
            "Yasuo_EQ3_cas" = "Characters/Yasuo/Skins/Skin9/Particles/Yasuo_Skin09_EQ3_cas"
            "Yasuo_EQ_cas" = "Characters/Yasuo/Skins/Skin9/Particles/Yasuo_Skin09_EQ_cas"
            "Yasuo_EQ_SwordGlow" = "Characters/Yasuo/Skins/Skin9/Particles/Yasuo_Skin09_EQ_SwordGlow"
            "Yasuo_E_Dash" = "Characters/Yasuo/Skins/Skin9/Particles/Yasuo_Skin09_E_Dash"
            "Yasuo_E_dash_hit" = "Characters/Yasuo/Skins/Skin9/Particles/Yasuo_Skin09_E_dash_hit"
            "Yasuo_E_timer1" = "Characters/Yasuo/Skins/Skin9/Particles/Yasuo_Skin09_E_timer1"
            "Yasuo_E_timer2" = "Characters/Yasuo/Skins/Skin9/Particles/Yasuo_Skin09_E_timer2"
            "Yasuo_E_timer3" = "Characters/Yasuo/Skins/Skin9/Particles/Yasuo_Skin09_E_timer3"
            "Yasuo_E_timer4" = "Characters/Yasuo/Skins/Skin9/Particles/Yasuo_Skin09_E_timer4"
            "Yasuo_E_timer5" = "Characters/Yasuo/Skins/Skin9/Particles/Yasuo_Skin09_E_timer5"
            "Yasuo_I_sheath_spark" = "Characters/Yasuo/Skins/Skin9/Particles/Yasuo_Skin09_I_sheath_spark"
            ...
            "Yasuo_Passive_Activate" = "Characters/Yasuo/Skins/Skin9/Particles/Yasuo_Skin09_Passive_Activate"
            "Yasuo_Passive_Burst" = "Characters/Yasuo/Skins/Skin9/Particles/Yasuo_Skin09_Passive_Burst"
            ...
            "Yasuo_Q_hit_tar" = "Characters/Yasuo/Skins/Skin9/Particles/Yasuo_Skin09_Q_hit_tar"
            "Yasuo_Q_sound" = "Characters/Yasuo/Skins/Skin0/Particles/Yasuo_Base_Q_sound"
            "Yasuo_Q_WindStrike" = "Characters/Yasuo/Skins/Skin9/Particles/Yasuo_Skin09_Q_WindStrike"
            "Yasuo_Q_WindStrike_02" = "Characters/Yasuo/Skins/Skin9/Particles/Yasuo_Skin09_Q_WindStrike_02"
            "Yasuo_Q_wind_hit_tar" = "Characters/Yasuo/Skins/Skin9/Particles/Yasuo_Skin09_Q_wind_hit_tar"
            "Yasuo_Q_wind_mis" = "Characters/Yasuo/Skins/Skin9/Particles/Yasuo_Skin09_Q_wind_mis"
            "Yasuo_Q_wind_ready_buff" = "Characters/Yasuo/Skins/Skin34/Particles/Yasuo_Skin34_Q_wind_ready_buff"
            ...
            "Yasuo_R_dash" = "Characters/Yasuo/Skins/Skin9/Particles/Yasuo_Skin09_R_dash"
            "Yasuo_R_impact_tar" = "Characters/Yasuo/Skins/Skin9/Particles/Yasuo_Skin09_R_impact_tar"
            "Yasuo_R_indicator_beam" = "Characters/Yasuo/Skins/Skin9/Particles/Yasuo_Skin09_R_indicator_beam"
            "Yasuo_R_land_tar" = "Characters/Yasuo/Skins/Skin9/Particles/Yasuo_Skin09_R_land_tar"
            "Yasuo_R_slash_cas" = "Characters/Yasuo/Skins/Skin9/Particles/Yasuo_Skin09_R_slash_cas"
            "Yasuo_R_SwordGlow" = "Characters/Yasuo/Skins/Skin34/Particles/Yasuo_Skin34_R_SwordGlow"
            ...
            "Yasuo_W_windwall1" = "Characters/Yasuo/Skins/Skin9/Particles/Yasuo_Skin09_W_windwall1"
            "Yasuo_W_windwall2" = "Characters/Yasuo/Skins/Skin9/Particles/Yasuo_Skin09_W_windwall2"
            "Yasuo_W_windwall3" = "Characters/Yasuo/Skins/Skin9/Particles/Yasuo_Skin09_W_windwall3"
            "Yasuo_W_windwall4" = "Characters/Yasuo/Skins/Skin9/Particles/Yasuo_Skin09_W_windwall4"
            "Yasuo_W_windwall5" = "Characters/Yasuo/Skins/Skin9/Particles/Yasuo_Skin09_W_windwall5"
            "Yasuo_W_windwall_activate" = "Characters/Yasuo/Skins/Skin0/Particles/Yasuo_Base_W_windwall_activate"
            "Yasuo_W_Windwall_big_impact" = "Characters/Yasuo/Skins/Skin9/Particles/Yasuo_Skin09_W_Windwall_big_impact"
            "Yasuo_W_windwall_enemy_01" = "Characters/Yasuo/Skins/Skin9/Particles/Yasuo_Skin09_W_windwall_enemy_01"
            "Yasuo_W_windwall_enemy_02" = "Characters/Yasuo/Skins/Skin9/Particles/Yasuo_Skin09_W_windwall_enemy_02"
            "Yasuo_W_windwall_enemy_03" = "Characters/Yasuo/Skins/Skin9/Particles/Yasuo_Skin09_W_windwall_enemy_03"
            "Yasuo_W_windwall_enemy_04" = "Characters/Yasuo/Skins/Skin9/Particles/Yasuo_Skin09_W_windwall_enemy_04"
            "Yasuo_W_windwall_enemy_05" = "Characters/Yasuo/Skins/Skin9/Particles/Yasuo_Skin09_W_windwall_enemy_05"
            ...
            "Yasuo_R_Charge_01" = "Characters/Yasuo/Skins/Skin9/Particles/Yasuo_Skin09_R_Charge_01"
            "Yasuo_R_Ghost_Trail" = "Characters/Yasuo/Skins/Skin9/Particles/Yasuo_Skin09_R_Ghost_Trail"
            "Yasuo_R_Ghosts_01" = "Characters/Yasuo/Skins/Skin34/Particles/Yasuo_Skin34_R_Ghosts_01"
            "Yasuo_Z_SparkGlow" = "Characters/Yasuo/Skins/Skin9/Particles/Yasuo_Skin09_Z_SparkGlow"
            "Yasuo_R_Swipe_01" = "Characters/Yasuo/Skins/Skin9/Particles/Yasuo_Skin09_R_Swipe_01"
            "Yasuo_Z_Dance_Burst" = "Characters/Yasuo/Skins/Skin9/Particles/Yasuo_Skin09_Z_Dance_Burst"
            "Yasuo_Z_Dance_Glow_FireBro" = "Characters/Yasuo/Skins/Skin9/Particles/Yasuo_Skin09_Z_Dance_Glow_FireBro"
            "Yasuo_Z_Dance_Glow_FireBro_S" = "Characters/Yasuo/Skins/Skin9/Particles/Yasuo_Skin09_Z_Dance_Glow_FireBro_S"
            "Yasuo_Z_Dance_Idle_FireBro" = "Characters/Yasuo/Skins/Skin9/Particles/Yasuo_Skin09_Z_Dance_Idle_FireBro"
            "Yasuo_Z_Death_BuildUp" = "Characters/Yasuo/Skins/Skin9/Particles/Yasuo_Skin09_Z_Death_BuildUp"
            "Yasuo_Z_Death_Crack" = "Characters/Yasuo/Skins/Skin9/Particles/Yasuo_Skin09_Z_Death_Crack"
            "Yasuo_Z_Death_Explode" = "Characters/Yasuo/Skins/Skin9/Particles/Yasuo_Skin09_Z_Death_Explode"
            "Yasuo_Z_Death_Impact" = "Characters/Yasuo/Skins/Skin34/Particles/Yasuo_Skin34_Z_Death_Impact"
            "Yasuo_Z_Idle_Eye01" = "Characters/Yasuo/Skins/Skin9/Particles/Yasuo_Skin09_Z_Idle_Eye01"
            "Yasuo_Z_Idle_Eye02" = "Characters/Yasuo/Skins/Skin9/Particles/Yasuo_Skin09_Z_Idle_Eye02"
            "Yasuo_Z_Idle_Flask_01" = "Characters/Yasuo/Skins/Skin9/Particles/Yasuo_Skin09_Z_Idle_Flask_01"
            "Yasuo_Z_Idle_Hair_01" = "Characters/Yasuo/Skins/Skin9/Particles/Yasuo_Skin09_Z_Idle_Hair_01"
            "Yasuo_Z_Joke_Firebro" = "Characters/Yasuo/Skins/Skin9/Particles/Yasuo_Skin09_Z_Joke_Firebro"
            "Yasuo_Z_Joke_Firebro_Death" = "Characters/Yasuo/Skins/Skin9/Particles/Yasuo_Skin09_Z_Joke_Firebro_Death"
            "Yasuo_Z_Joke_Firebro_Idle" = "Characters/Yasuo/Skins/Skin9/Particles/Yasuo_Skin09_Z_Joke_Firebro_Idle"
            "Yasuo_Z_Joke_Open" = "Characters/Yasuo/Skins/Skin9/Particles/Yasuo_Skin09_Z_Joke_Open"
            "Yasuo_Z_Joke_PopOut" = "Characters/Yasuo/Skins/Skin9/Particles/Yasuo_Skin09_Z_Joke_PopOut"
            "Yasuo_Z_Laugh_AvatarGlow" = "Characters/Yasuo/Skins/Skin9/Particles/Yasuo_Skin09_Z_Laugh_AvatarGlow"
            "Yasuo_Z_Laugh_Trail" = "Characters/Yasuo/Skins/Skin9/Particles/Yasuo_Skin09_Z_Laugh_Trail"
            "Yasuo_Z_Recall_BodyGlow" = "Characters/Yasuo/Skins/Skin34/Particles/Yasuo_Skin34_Z_Recall_BodyGlow"
            "Yasuo_Z_Recall_HeadSmash" = "Characters/Yasuo/Skins/Skin9/Particles/Yasuo_Skin09_Z_Recall_HeadSmash"
            "Yasuo_Z_Recall_Spikes" = "Characters/Yasuo/Skins/Skin9/Particles/Yasuo_Skin09_Z_Recall_Spikes"
            "Yasuo_Z_Recall_Transform_01" = "Characters/Yasuo/Skins/Skin9/Particles/Yasuo_Skin09_Z_Recall_Transform_01"
            "Yasuo_Z_Recall_Transform_02" = "Characters/Yasuo/Skins/Skin9/Particles/Yasuo_Skin09_Z_Recall_Transform_02"
            "Yasuo_Z_Respawn" = "Characters/Yasuo/Skins/Skin9/Particles/Yasuo_Skin09_Z_Respawn"
            "Yasuo_Z_Respawn_Crater" = "Characters/Yasuo/Skins/Skin9/Particles/Yasuo_Skin09_Z_Respawn_Crater"
            "Yasuo_Z_Taunt_Sword_Fire" = "Characters/Yasuo/Skins/Skin9/Particles/Yasuo_Skin09_Z_Taunt_Sword_Fire"
            "Yasuo_Z_Taunt_Sword_Flick" = "Characters/Yasuo/Skins/Skin9/Particles/Yasuo_Skin09_Z_Taunt_Sword_Flick"
            "Yasuo_Z_Tuant_FireBreath_01" = "Characters/Yasuo/Skins/Skin9/Particles/Yasuo_Skin09_Z_Tuant_FireBreath_01"
            "Yasuo_Z_Tuant_FireBreath_02" = "Characters/Yasuo/Skins/Skin9/Particles/Yasuo_Skin09_Z_Tuant_FireBreath_02"
        }
    }
}
