...
entries: map[hash,embed] = {
    0xb85ae11a = SkinCharacterDataProperties {
        skinClassification: u32 = 2
        championSkinName: string = "YasuoSkin46"
        skinParent: i32 = 45
    ...
    0x1e12d3e8 = StaticMaterialDef {
        name: string = "Characters/Yasuo/Skins/Skin46/Materials/ScreenSpace_Hair_inst"
        samplerValues: list2[embed] = {
            StaticMaterialShaderSamplerDef {
                textureName: string = "Diffuse_Texture"
                texturePath: string = "ASSETS/Characters/Yasuo/Skins/Skin46/Yasuo_Skin46_TX_CM.dds"
                addressU: u32 = 1
                addressV: u32 = 1
                addressW: u32 = 1
            }
            StaticMaterialShaderSamplerDef {
                ...
                texturePath: string = "ASSETS/Characters/Yasuo/Skins/Skin46/Particles/Yasuo_Skin46_HairFlow.dds"
                addressW: u32 = 1
            }
        }
        paramValues: list2[embed] = {
            ...
            StaticMaterialShaderParamDef {
                ...
                value: vec4 = { 1, 0.952941179, 0.431372553, 1 }
            }
            StaticMaterialShaderParamDef {
            ...
            StaticMaterialShaderParamDef {
                ...
                value: vec4 = { 1, 0.933333337, 0.423529416, 1 }
            }
            StaticMaterialShaderParamDef {
    ...
    0x2b7a9feb = StaticMaterialDef {
        name: string = "Characters/Yasuo/Skins/Skin46/Materials/Diffuse_Bloom_Tentacles_inst"
        samplerValues: list2[embed] = {
            StaticMaterialShaderSamplerDef {
                textureName: string = "Diffuse_Texture"
                texturePath: string = "ASSETS/Characters/Yasuo/Skins/Skin46/Yasuo_Skin46_Tentacle_TX_CM.dds"
                addressU: u32 = 1
                addressV: u32 = 1
                addressW: u32 = 1
            }
        ...
        paramValues: list2[embed] = {
            ...
            StaticMaterialShaderParamDef {
                ...
                value: vec4 = { 0.815686285, 0.188235298, 0.0627451017, 0 }
            }
            StaticMaterialShaderParamDef {
    ...
    0xb150e323 = StaticMaterialDef {
        name: string = "Characters/Yasuo/Skins/Skin46/Materials/ScreenSpace_Shoulder_Tentacle_inst"
        samplerValues: list2[embed] = {
            StaticMaterialShaderSamplerDef {
                textureName: string = "Diffuse_Texture"
                texturePath: string = "ASSETS/Characters/Yasuo/Skins/Skin46/Yasuo_Skin46_TX_CM.dds"
        ...
        paramValues: list2[embed] = {
            ...
            StaticMaterialShaderParamDef {
                name: string = "Color_Fresnel_color"
                value: vec4 = { 1, 0.486274511, 0.117647059, 0 }
            }
            StaticMaterialShaderParamDef {
                name: string = "SS_ScrollSpeed"
                value: vec4 = { 0, -0.25, 0, 0 }
    ...
    0x49747f3d = VfxSystemDefinitionData {
        complexEmitterDefinitionData: list[pointer] = {
            VfxEmitterDefinitionData {
                ...
                color: embed = ValueColor {
                    ...
                    dynamics: pointer = VfxAnimatedColorVariableData {
                        ...
                        values: list[vec4] = {
                            { 1, 0.352941185, 0.0791234747, 0 }
                            { 1, 0.318339199, 0.0791234747, 1 }
                            { 1, 0.186851278, 0.192156866, 1 }
                            { 0.529411972, 0.275432467, 0.192156866, 0 }
                        }
                    }
                }
                alphaRef: u8 = 0
            ...
            VfxEmitterDefinitionData {
                ...
                blendMode: u8 = 4
                color: embed = ValueColor {
                    constantValue: vec4 = { 1, 0.466666669, 0.200000003, 1 }
                    dynamics: pointer = VfxAnimatedColorVariableData {
                        times: list[f32] = {
                            0
                            0.200000003
                        ...
                        values: list[vec4] = {
                            { 0.850980401, 0.444705874, 0.200000003, 0 }
                            { 0.862745106, 0.441045761, 0.200000003, 1 }
                            { 1, 0.40993464, 0.157647058, 1 }
                            { 1, 0.144575164, 0.0345098041, 1 }
                        }
                    }
                }
                pass: i16 = 10
            ...
            VfxEmitterDefinitionData {
                ...
                color: embed = ValueColor {
                    constantValue: vec4 = { 1, 0.0666666701, 0, 1 }
                    dynamics: pointer = VfxAnimatedColorVariableData {
                        times: list[f32] = {
                            0
                            0.300000012
        ...
        particleName: string = "Yasuo_Skin46_Idle_HairGlow"
        particlePath: string = "Characters/Yasuo/Skins/Skin46/Particles/Yasuo_Skin46_Idle_HairGlow"
        flags: u16 = 197
    }
    0x8f392309 = VfxSystemDefinitionData {
        complexEmitterDefinitionData: list[pointer] = {
            VfxEmitterDefinitionData {
                rate: embed = ValueFloat {
                    constantValue: f32 = 4
                ...
                color: embed = ValueColor {
                    constantValue: vec4 = { 0.498039216, 0.235294119, 0.0627451017, 1 }
                    dynamics: pointer = VfxAnimatedColorVariableData {
                        times: list[f32] = {
                            0
                            0.300000012
                        ...
                        values: list[vec4] = {
                            { 0.498039216, 0.235294119, 0.0258362368, 0 }
                            { 0.498039216, 0.212226123, 0.0258362368, 1 }
                            { 0.498039216, 0.124567524, 0.0627451017, 1 }
                            { 0.263667911, 0.183621645, 0.0627451017, 0 }
                        }
                    }
                }
                alphaRef: u8 = 0
        ...
        particleName: string = "Yasuo_Skin46_Idle_ShoulderGlow"
        particlePath: string = "Characters/Yasuo/Skins/Skin46/Particles/Yasuo_Skin46_Idle_ShoulderGlow"
        flags: u16 = 197
    }
    0xe0429f08 = ResourceResolver {
        resourceMap: map[hash,link] = {
            ...
            0xdc800b02 = 0x49747f3d
            0xf9323446 = 0x8f392309
