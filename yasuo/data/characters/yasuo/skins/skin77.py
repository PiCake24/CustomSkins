...
entries: map[hash,embed] = {
    0x29624ec2 = SkinCharacterDataProperties {
    ...
    0x087d8771 = VfxSystemDefinitionData {
    ...
    0x3574ce9a = VfxSystemDefinitionData {
        complexEmitterDefinitionData: list[pointer] = {
            VfxEmitterDefinitionData {
                rate: embed = ValueFloat {
                    constantValue: f32 = 1
